...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function Ja(){return new kn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:yr(),fragmentShader:`
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function Qa(){return new kn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:yr(),fragmentShader:`
...
<svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M12 4v16M12 4l6 6M12 4l-6 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    `,document.head.appendChild(e)}getElement(){return this.element}remove(){this.element.remove()}}const Rr="vrplayer_config_draft_v1";function wo(){try{const i=localStorage.getItem(Rr);return i?JSON.parse(i):null}catch(i){return console.warn("加载草稿失败",i),null}}function sg(i){try{const e=JSON.stringify(i);return localStorage.setItem(Rr,e),{ok:!0}}catch(e){return console.warn("保存草稿失败",e),{ok:!1,reason:e instanceof Error?e.message:"unknown"}}}function rg(){try{localStorage.removeItem(Rr)}catch(i){console.warn("清空草稿失败",i)}}const El="vr_last_pick_v1";let Pr=null;function ag(){try{const i=localStorage.getItem(El);if(i){const e=JSON.parse(i);typeof e.yaw=="number"&&typeof e.pitch=="number"&&typeof e.ts=="number"&&(Pr=e)}}catch{}}ag();function og(i){Pr=i;try{localStorage.setItem(El,JSON.stringify(i))}catch{}}function Ao(){return Pr}const Io="vrplayer_config_draft_ignore_session";class lg{constructor(e,t){v(this,"element");v(this,"config");v(this,"initialConfig");v(this,"editingTarget",{type:"global"});v(this,"simpleMode",!0);v(this,"validationErrors",[]);v(this,"validationDebounceTimer",null);v(this,"draftSaveTimer",null);v(this,"draftLoaded",!1);v(this,"draftIgnoreSession",!1);v(this,"draftBannerMessage",null);v(this,"onConfigChange");this.config=JSON.parse(JSON.stringify(e)),this.initialConfig=JSON.parse(JSON.stringify(e)),this.onConfigChange=t;try{this.draftIgnoreSession=sessionStorage.getItem(Io)==="1"}catch(n){console.warn("读取草稿忽略状态失败",n),this.draftIgnoreSession=!1}this.tryRestoreDraft(),this.element=document.createElement("div"),this.element.className="config-studio",this.render(),this.applyStyles(),this.renderDraftBanner(),this.validateConfig()}tryRestoreDraft(){if(this.draftIgnoreSession)return;const e=wo();e&&(this.config=JSON.parse(JSON.stringify(e)),this.draftLoaded=!0,this.draftBannerMessage="检测到未导出的草稿，已自动恢复。",this.onConfigChange&&this.onConfigChange(this.config))}renderDraftBanner(){const e=this.element.querySelector("#draft-banner");if(!e)return;if(!this.draftLoaded||this.draftIgnoreSession){e.innerHTML="",e.style.display="none";return}const t=this.draftBannerMessage||"检测到未导出的草稿，已自动恢复。";e.innerHTML=`
...
<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  "museums": [
    ...
    `,this.appElement.appendChild(n);const s=Gl();this.panoViewer=new Dm(n,s),this.topBar=new _g({title:t.name||((_=this.config)==null?void 0:_.appName)||"VR Player",viewerRootEl:n,onTogglePickMode:()=>{if(!this.panoViewer)return!1;const f=this.panoViewer.togglePickMode();return it(f?"拾取已开启：点一下画面获取 yaw/pitch":"拾取已关闭"),f}}),this.appElement.appendChild(this.topBar.getElement());const r=f=>{const u=f,{x:y,y:S,yaw:w,pitch:R}=u.detail;if(og({yaw:w,pitch:R,ts:Date.now()}),it(`已复制 yaw: ${w.toFixed(2)}, pitch: ${R.toFixed(2)}`),this.panoViewer){const I=this.panoViewer.getDomElement();Xg(I,y,S)}};window.addEventListener("vr:pick",r);const a=f=>{const u=f;this.panoViewer&&!u.detail.enabled&&this.panoViewer.isPickModeEnabled()&&(this.panoViewer.disablePickMode(),this.topBar)};if(window.addEventListener("vr:pickmode",a),this.brandMark=new Sg({appName:(g=this.config)==null?void 0:g.appName,brandText:"鼎虎清源"}),this.appElement.appendChild(this.brandMark.getElement()),this.appElement.appendChild(this.brandMark.getAboutModal().getElement()),s){this.debugPanel=new ig,this.appElement.appendChild(this.debugPanel.getElement()),this.panoViewer.setOnDebugClick((u,y,S,w,R)=>{this.debugPanel&&this.debugPanel.show(u,y,S,w,R)});const f=()=>{if(this.debugPanel&&this.panoViewer){const u=this.panoViewer.getCurrentView();this.debugPanel.updateView(u.yaw,u.pitch,u.fov)}requestAnimationFrame(f)};f()}this.videoPlayer=new eg,this.appElement.appendChild(this.videoPlayer.getElement()),this.sceneGuideDrawer=new Gg({scenes:e.scenes}),this.appElement.appendChild(this.sceneGuideDrawer.getElement());const o=e.scenes.flatMap(f=>f.hotspots);this.sceneStrip=new Vg({museumId:e.id,currentSceneId:t.id,hotspots:o,scenes:e.scenes,onNavigateToScene:f=>{jt(e.id,f)}}),n.appendChild(this.sceneStrip.getElement());const l=new Map;e.scenes.forEach(f=>{let u;if(f.panoLow){const y=dn(f.panoLow,Zt.PANO_LOW);y&&(u=y)}else if(f.pano){const y=dn(f.pano,Zt.PANO);y&&(u=y)}l.set(f.id,{title:f.name,thumb:f.thumb,panoUrl:u})}),this.scenePreviewCard=new Wg(n,{museumId:e.id,getSceneMeta:f=>l.get(f)??null}),this.bottomDock=new Hg({initialTab:"guide",onGuideClick:()=>{var f;return(f=this.sceneGuideDrawer)==null?void 0:f.toggle()},sceneId:t.id,sceneName:t.name,museum:e,scenes:e.scenes,currentSceneId:t.id}),this.appElement.appendChild(this.bottomDock.getElement());const c=new Map(e.scenes.map(f=>[f.id,f.name]));this.hotspots=new Qm(this.panoViewer,t.hotspots,{resolveSceneName:f=>c.get(f),onEnterScene:f=>{jt(e.id,f)},museumId:e.id}),n.appendChild(this.hotspots.getElement()),this.qualityIndicator=new _m,this.appElement.appendChild(this.qualityIndicator.getElement()),this.panoViewer.setOnStatusChange(f=>{this.qualityIndicator&&this.qualityIndicator.updateStatus(f)}),this.panoViewer.setOnLoad(()=>{this.loading.hide(),this.preloadNextScene(e,t)}),this.panoViewer.setOnError(f=>{console.error("加载场景失败:",f),this.loading.hide(),this.showError("加载全景图失败，请检查网络连接"),this.qualityIndicator&&this.qualityIndicator.updateStatus(yt.ERROR)});const d=qr(),h=d.yaw!==void 0?d.yaw:t.initialView.yaw||0,p=d.pitch!==void 0?d.pitch:t.initialView.pitch||0,m=d.fov!==void 0?d.fov:t.initialView.fov||75;this.panoViewer.setView(h,p,m),this.panoViewer.loadScene(t),this.panoViewer.setSceneData(e.id,t.id,t.hotspots)}preloadNextScene(e,t){const s=(e.scenes.findIndex(a=>a.id===t.id)+1)%e.scenes.length,r=e.scenes[s];r&&r.thumb&&mr(async()=>{const{resolveAssetUrl:a,AssetType:o}=await Promise.resolve().then(()=>vm);return{resolveAssetUrl:a,AssetType:o}},void 0,import.meta.url).then(({resolveAssetUrl:a,AssetType:o})=>{const l=a(r.thumb,o.THUMB);if(l){const c=new Image;c.src=l}})}clearView(){this.panoViewer&&(this.panoViewer.dispose(),this.panoViewer=null),this.titleBar&&(this.titleBar.remove(),this.titleBar=null),this.topBar&&(this.topBar.remove(),this.topBar=null),this.brandMark&&(this.brandMark.remove(),this.brandMark=null),this.bottomDock&&(this.bottomDock.remove(),this.bottomDock=null),this.sceneGuideDrawer&&(this.sceneGuideDrawer.remove(),this.sceneGuideDrawer=null),this.sceneStrip&&(this.sceneStrip.dispose(),this.sceneStrip=null),this.scenePreviewCard&&(this.scenePreviewCard.dispose(),this.scenePreviewCard=null),this.museumList&&(this.museumList.remove(),this.museumList=null),this.sceneList&&(this.sceneList.remove(),this.sceneList=null),this.mapOverlay&&(this.mapOverlay.remove(),this.mapOverlay=null),this.hotspots&&(this.hotspots.remove(),this.hotspots=null),this.videoPlayer&&(this.videoPlayer.remove(),this.videoPlayer=null),this.controlBar&&(this.controlBar.remove(),this.controlBar=null),this.debugPanel&&(this.debugPanel.remove(),this.debugPanel=null),this.configStudio&&(this.configStudio.remove(),this.configStudio=null),this.qualityIndicator&&(this.qualityIndicator.remove(),this.qualityIndicator=null),this.appElement.innerHTML="",this.appElement.appendChild(this.loading.getElement())}showError(e){const t=document.createElement("div");t.className="error-message",t.textContent=e,t.style.cssText=`
      ...
      text-align: center;
      max-width: 80vw;
    `,this.appElement.appendChild(t),setTimeout(()=>{t.remove()},3e3)}}new ev;export{di as E,nv as M,In as P,Ci as Q,Qo as R,sv as S,iv as T,N as V,Ge as a,On as b};
