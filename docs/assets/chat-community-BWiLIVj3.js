var T=Object.defineProperty;var S=(l,t,e)=>t in l?T(l,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[t]=e;var o=(l,t,e)=>S(l,typeof t!="symbol"?t+"":t,e);import{l as B,a as N,g as C,t as _,b as I,c as L,d as O}from"./store-B83L8bDT.js";import{s as b}from"./index-Bu0HK7CK.js";const g=40,x=120,P="fcchat_history_v2",z="fcchat_session_v1",R="fcchat_user_memory_v1";function w(l,t){const e=(t||"global").trim()||"global";return`${l}:${e}`}function k(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():`fcchat_${Date.now()}_${Math.random().toString(36).slice(2,10)}`}class A{constructor(t,e){o(this,"client");o(this,"context");o(this,"root");o(this,"header");o(this,"body");o(this,"list");o(this,"input");o(this,"sendBtn");o(this,"clearBtn");o(this,"closeBtn");o(this,"statusLine");o(this,"dragging",!1);o(this,"dragOffsetX",0);o(this,"dragOffsetY",0);o(this,"isMobile",!1);o(this,"swipeStartY",0);o(this,"swipeActive",!1);o(this,"messages",[]);o(this,"isOpen",!1);o(this,"fabButton",null);o(this,"historyStorageKey");o(this,"sessionStorageKey");o(this,"userMemoryStorageKey");o(this,"sessionId");o(this,"userMemory",[]);o(this,"snapTimer",null);o(this,"isDragging",!1);o(this,"startX",0);o(this,"startY",0);o(this,"startLeft",0);o(this,"startTop",0);o(this,"lastLeft",0);o(this,"lastTop",0);o(this,"moved",!1);o(this,"hasUserPlaced",!1);o(this,"typingTimer",null);o(this,"typingAbortToken",0);this.client=t,this.context=e,this.historyStorageKey=w(P,e.museumId),this.sessionStorageKey=w(z,e.museumId),this.userMemoryStorageKey=w(R,e.museumId),this.sessionId=this.loadSessionId(),this.userMemory=this.loadUserMemory(),this.mount(),this.injectStyles(),this.detectMobile(),this.restoreHistoryOrWelcome()}destroy(){var t,e;this.stopTyping(!0),this.snapTimer&&(window.clearTimeout(this.snapTimer),this.snapTimer=null),(t=this.root)==null||t.remove(),(e=this.fabButton)==null||e.remove(),this.fabButton=null}detectMobile(){var s,n;const t=((s=window.matchMedia)==null?void 0:s.call(window,"(max-width: 768px)").matches)??!1,e=((n=window.matchMedia)==null?void 0:n.call(window,"(pointer: coarse)").matches)??!1;this.isMobile=t||e,this.root.dataset.mobile=this.isMobile?"1":"0"}mount(){this.root=document.createElement("div"),this.root.className="fcchat-root",this.root.setAttribute("role","dialog"),this.root.setAttribute("aria-label","三馆学伴"),this.header=document.createElement("div"),this.header.className="fcchat-header";const t=document.createElement("div");t.className="fcchat-title",t.textContent="三馆学伴";const e=document.createElement("div");e.className="fcchat-header-right",this.clearBtn=document.createElement("button"),this.clearBtn.className="fcchat-btn fcchat-btn-ghost",this.clearBtn.type="button",this.clearBtn.textContent="清空",this.clearBtn.addEventListener("click",()=>this.clear()),this.closeBtn=document.createElement("button"),this.closeBtn.className="fcchat-btn fcchat-btn-ghost fcchat-close",this.closeBtn.type="button",this.closeBtn.setAttribute("aria-label","关闭"),this.closeBtn.textContent="×",this.closeBtn.addEventListener("click",()=>this.toggle()),e.appendChild(this.clearBtn),e.appendChild(this.closeBtn);const s=document.createElement("div");s.className="fcchat-header-row",s.appendChild(t),s.appendChild(e),this.header.appendChild(s);const n=document.createElement("div");n.className="fcchat-disclaimer",n.textContent="提示：AI 可能会出错，内容仅供参考；请以现场展陈/讲解为准。",this.header.appendChild(n),this.body=document.createElement("div"),this.body.className="fcchat-body",this.list=document.createElement("div"),this.list.className="fcchat-list",this.body.appendChild(this.list),this.statusLine=document.createElement("div"),this.statusLine.className="fcchat-status",this.statusLine.textContent="",this.body.appendChild(this.statusLine);const i=document.createElement("div");i.className="fcchat-inputbar",this.input=document.createElement("input"),this.input.className="fcchat-input",this.input.type="text",this.input.placeholder="输入问题，回车发送",this.input.addEventListener("keydown",a=>{a.key==="Enter"&&this.onSend()}),this.sendBtn=document.createElement("button"),this.sendBtn.className="fcchat-btn fcchat-btn-primary",this.sendBtn.type="button",this.sendBtn.textContent="发送",this.sendBtn.addEventListener("click",()=>this.onSend()),i.appendChild(this.input),i.appendChild(this.sendBtn),this.root.appendChild(this.header),this.root.appendChild(this.body),this.root.appendChild(i),document.body.appendChild(this.root),this.root.style.display="none",this.root.style.right="18px",this.root.style.bottom="18px",this.ensureToggleButton(),this.header.addEventListener("mousedown",a=>this.onDragStart(a)),window.addEventListener("mousemove",a=>this.onDragMove(a)),window.addEventListener("mouseup",()=>this.onDragEnd()),this.header.addEventListener("pointerdown",a=>this.onSwipeStart(a),{passive:!1}),this.header.addEventListener("pointermove",a=>this.onSwipeMove(a),{passive:!1}),this.header.addEventListener("pointerup",a=>this.onSwipeEnd(a)),this.header.addEventListener("pointercancel",a=>this.onSwipeEnd(a)),window.addEventListener("resize",()=>this.detectMobile())}hide(){this.isOpen&&(this.isOpen=!1,this.stopTyping(!0),this.root.style.display="none",this.root.classList.remove("fcchat-open"),this.fabButton&&this.fabButton.classList.add("fcchat-docked"),document.body.classList.remove("fcchat-open"),this.updateOverlayState())}show(){this.isOpen||(this.isOpen=!0,this.detectMobile(),this.root.style.display="flex",this.root.classList.add("fcchat-open"),this.fabButton&&this.fabButton.classList.remove("fcchat-docked"),document.body.classList.add("fcchat-open"),this.scrollToBottom(),this.isMobile||this.input.focus(),this.updateOverlayState())}toggle(){this.isOpen?this.hide():this.show()}updateOverlayState(){!!(document.querySelector(".vr-modal-overlay")||document.querySelector(".vr-guide-drawer.open")||this.root&&this.root.style.display==="flex")?document.documentElement.classList.add("vr-overlay-open"):document.documentElement.classList.remove("vr-overlay-open")}getSafeBounds(){const t=window.innerWidth,e=window.innerHeight,s=this.fabButton;if(!s)return{minLeft:8,maxLeft:t-52,minTop:12,maxTop:e-64};const n=s.getBoundingClientRect(),i=n.width,a=n.height,c=12+(this.isMobile?56:12),r=12+(this.isMobile?96:12);return{minLeft:8,maxLeft:t-i-8,minTop:c,maxTop:e-a-r}}clampPos(t,e){const s=this.getSafeBounds();return{left:Math.max(s.minLeft,Math.min(t,s.maxLeft)),top:Math.max(s.minTop,Math.min(e,s.maxTop))}}snapToEdge(){const t=this.fabButton;if(!t)return;const e=this.getSafeBounds(),s=t.getBoundingClientRect(),n=s.left,i=s.top,a=n-e.minLeft,c=e.maxLeft-n,r=i-e.minTop,d=e.maxTop-i,h=Math.min(a,c,r,d);let p=n,m=i;h===a?p=e.minLeft:h===c?p=e.maxLeft:h===r?m=e.minTop:h===d&&(m=e.maxTop),t.style.left=`${p}px`,t.style.top=`${m}px`,t.style.right="auto",t.style.bottom="auto",localStorage.setItem("fcchat_fab_pos_v1",JSON.stringify({left:p,top:m})),setTimeout(()=>{t.classList.remove("fcchat-snapping")},220)}ensureToggleButton(){if(this.fabButton)return;const t=new URLSearchParams(location.search);if(t.get("reset_ui")==="1"){localStorage.removeItem("vr_fcchat_dock_state"),t.delete("reset_ui");const n=location.pathname+(t.toString()?"?"+t.toString():"")+location.hash;history.replaceState({},"",n)}const e=document.createElement("button");e.id="fcchat-fab",e.className="fcchat-fab fcchat-docked",e.type="button",e.setAttribute("aria-label","打开三馆学伴"),e.innerHTML=`<svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    `,document.head.appendChild(t)}getElement(){return this.root}remove(){this.destroy()}}const J=Object.freeze(Object.defineProperty({__proto__:null,FcChatPanel:A},Symbol.toStringTag,{value:"Module"}));function $(l){try{return JSON.parse(l)}catch{return null}}function E(l){return typeof l=="string"?l:""}function D(l){return l.endsWith("/")?l:l+"/"}function X(l,t,e=[],s=""){const n=e.map(r=>({role:r.role==="assistant"?"assistant":"user",content:typeof r.text=="string"?r.text.trim():"",text:typeof r.text=="string"?r.text.trim():""})).filter(r=>!!r.content),i=Array.isArray(t==null?void 0:t.userMemory)?t.userMemory.map(r=>typeof r=="string"?r.trim():"").filter(r=>!!r).slice(-30):[];let a=l;if(i.length>0){const r=i.slice(-8).map((d,h)=>`${h+1}. ${d}`).join(`
`);a=`${l}

【用户已提供信息（按时间）】
${r}

请优先依据以上用户信息回答；若问题涉及“我刚才/今天说了什么”，请直接基于这些信息作答，不要回答“你不记得”或“你没有记忆功能”。`}const c={question:a,rawQuestion:l};return s&&(c.sessionId=s,c.conversationId=s),n.length>0&&(c.history=n,c.messages=n,c.chatHistory=n.map(r=>({role:r.role,text:r.text}))),t&&typeof t=="object"&&(c.context={museumId:t.museumId||"",museumName:t.museumName||"",sceneId:t.sceneId||"",sceneTitle:t.sceneTitle||"",url:t.url||"",sessionId:s||"",historyLength:n.length,userMemory:i,userMemoryLength:i.length}),c}function Y(l){if(l&&typeof l=="object"&&typeof l.answer=="string"&&l.answer.trim())return{ok:!0,answer:l.answer.trim(),model:E(l.model)||void 0};if(l&&typeof l=="object"&&("code"in l||"msg"in l||"data"in l)){const t=typeof l.code=="number"?l.code:void 0,e=E(l.msg)||"",s=l.data;if((t===0||t===void 0)&&s&&typeof s=="object"){const n=typeof s.answer=="string"?s.answer.trim():"";if(n)return{ok:!0,answer:n,model:E(s.model)||void 0}}if(t===40101||e.toLowerCase()==="unauthorized")return{ok:!1,code:40101,msg:"unauthorized"};if(t!==void 0&&t!==0)return{ok:!1,code:t,msg:e||`error code=${t}`};if(e&&e.toLowerCase()!=="ok")return{ok:!1,code:t,msg:e}}return{ok:!1,msg:"bad response"}}class F{constructor(t){o(this,"endpoint");o(this,"authToken");o(this,"timeoutMs");if(!(t!=null&&t.endpoint))throw new Error("fcChat endpoint is empty");this.endpoint=D(t.endpoint),this.authToken=t.authToken||"",this.timeoutMs=typeof t.timeoutMs=="number"&&t.timeoutMs>0?t.timeoutMs:15e3}async ask(t,e,s=[],n=""){const i=(t||"").trim();if(!i)throw new Error("empty question");const a=new AbortController,c=setTimeout(()=>a.abort(),this.timeoutMs);try{const r={"Content-Type":"application/json"};this.authToken&&(r.Authorization=this.authToken.startsWith("Bearer ")?this.authToken:`Bearer ${this.authToken}`);const d=await fetch(this.endpoint,{method:"POST",headers:r,body:JSON.stringify(X(i,e,s,n)),signal:a.signal}),h=await d.text(),p=$(h);if(!p){const f=h?`bad response: ${h}`:`http ${d.status}`;throw new Error(f)}const m=Y(p);if(m.ok)return{answer:m.answer,model:m.model};if(m.code===40101){const f=new Error("unauthorized (code=40101)");throw f.code=40101,f}const y=m.code?`${m.msg} (code=${m.code})`:m.msg;throw new Error(y||"request failed")}catch(r){throw(r==null?void 0:r.name)==="AbortError"?new Error(`timeout (${this.timeoutMs}ms)`):r}finally{clearTimeout(c)}}}const j=Object.freeze(Object.defineProperty({__proto__:null,FcChatClient:F},Symbol.toStringTag,{value:"Module"}));class H{constructor(t={}){o(this,"element");o(this,"isOpen",!1);o(this,"inputEl");o(this,"options");o(this,"handleKeyDownBound");this.options=t,this.handleKeyDownBound=u=>this.handleKeyDown(u),this.element=document.createElement("div"),this.element.className="vr-modal vr-login-modal";const e=document.createElement("div");e.className="vr-modal-mask";const s=document.createElement("div");s.className="vr-modal-card vr-login-card";const n=document.createElement("div");n.className="vr-login-title-row";const i=document.createElement("div");i.className="vr-modal-title",i.textContent="登录";const a=document.createElement("button");a.className="vr-btn vr-login-close",a.setAttribute("aria-label","关闭"),a.textContent="×",a.addEventListener("click",()=>this.close()),n.appendChild(i),n.appendChild(a);const c=document.createElement("div");c.className="vr-modal-desc",c.textContent="输入用户名即可参与互动";const r=document.createElement("div");r.className="vr-login-form",this.inputEl=document.createElement("input"),this.inputEl.className="vr-login-input",this.inputEl.type="text",this.inputEl.placeholder="用户名（2-12字）",this.inputEl.maxLength=12,this.inputEl.addEventListener("keydown",u=>{u.key==="Enter"&&this.handleConfirm()});const d=document.createElement("div");d.className="vr-modal-actions vr-login-actions";const h=document.createElement("button");h.className="vr-btn vr-login-btn",h.textContent="取消",h.addEventListener("click",()=>this.close());const p=document.createElement("button");p.className="vr-btn vr-login-btn danger",p.textContent="退出登录",p.addEventListener("click",()=>{var u,v;B(),(v=(u=this.options).onLogout)==null||v.call(u),this.close()});const m=document.createElement("button");m.className="vr-btn vr-login-btn primary",m.textContent="确认",m.addEventListener("click",()=>this.handleConfirm()),d.appendChild(h),d.appendChild(p),d.appendChild(m),r.appendChild(this.inputEl),s.appendChild(n),s.appendChild(c),s.appendChild(r),s.appendChild(d),e.addEventListener("click",()=>this.close()),s.addEventListener("click",u=>u.stopPropagation()),this.element.appendChild(e),this.element.appendChild(s);const y=()=>{const u=C();p.style.display=u?"inline-flex":"none"},f=this.open.bind(this);this.open=()=>{y(),f()}}handleKeyDown(t){this.isOpen&&t.key==="Escape"&&this.close()}handleConfirm(){var s,n;const t=(this.inputEl.value||"").trim();if(t.length<2||t.length>12){b("用户名需 2-12 字");return}const e=N(t);(n=(s=this.options).onLogin)==null||n.call(s,e),this.close()}open(){if(this.isOpen)return;this.isOpen=!0,window.addEventListener("keydown",this.handleKeyDownBound);const t=C();this.inputEl.value=(t==null?void 0:t.name)||"",this.element.classList.add("open"),window.setTimeout(()=>this.inputEl.focus(),60)}close(){this.isOpen&&(this.isOpen=!1,window.removeEventListener("keydown",this.handleKeyDownBound),this.element.classList.remove("open"))}getElement(){return this.element}remove(){window.removeEventListener("keydown",this.handleKeyDownBound),this.element.remove()}}class U{constructor(t){o(this,"element");o(this,"sceneId");o(this,"sceneName");o(this,"onClose");o(this,"subtitleEl");o(this,"loginHintBtn");o(this,"userLineEl");o(this,"userNameEl");o(this,"likeBtn");o(this,"likeCountEl");o(this,"commentsEl");o(this,"inputEl");o(this,"sendBtn");o(this,"loginModal");o(this,"highlightNextFirstComment",!1);this.sceneId=t.sceneId,this.sceneName=t.sceneName,this.onClose=t.onClose,this.element=document.createElement("div"),this.element.className="vr-community";const e=document.createElement("div");e.className="vr-community-header";const s=document.createElement("div");s.className="vr-community-title",s.textContent="社区",this.subtitleEl=document.createElement("div"),this.subtitleEl.className="vr-community-subtitle";const n=document.createElement("button");n.className="vr-community-close",n.innerHTML="×",n.setAttribute("aria-label","关闭"),n.style.pointerEvents="auto",n.style.zIndex="10",n.addEventListener("click",h=>{var p;h.preventDefault(),h.stopPropagation(),h.stopImmediatePropagation(),(p=this.onClose)==null||p.call(this),window.dispatchEvent(new CustomEvent("vr:dock-tab-close",{detail:{tab:"community"}}))}),e.appendChild(s),e.appendChild(this.subtitleEl),e.appendChild(n);const i=document.createElement("div");i.className="vr-community-content";const a=document.createElement("div");a.className="vr-community-auth",this.loginHintBtn=document.createElement("button"),this.loginHintBtn.className="vr-btn vr-community-login-hint",this.loginHintBtn.textContent="登录后可参与互动",this.userLineEl=document.createElement("div"),this.userLineEl.className="vr-community-userline",this.userNameEl=document.createElement("div"),this.userNameEl.className="vr-community-username";const c=document.createElement("button");c.className="vr-btn vr-community-logout",c.textContent="退出登录",c.addEventListener("click",()=>{B(),this.refresh(),this.toast("已退出登录")}),this.userLineEl.appendChild(this.userNameEl),this.userLineEl.appendChild(c),a.appendChild(this.loginHintBtn),a.appendChild(this.userLineEl);const r=document.createElement("div");r.className="vr-community-like",this.likeBtn=document.createElement("button"),this.likeBtn.className="vr-btn vr-community-likebtn",this.likeBtn.textContent="点赞",this.likeCountEl=document.createElement("div"),this.likeCountEl.className="vr-community-likecount",this.likeBtn.addEventListener("click",()=>{const h=_(this.sceneId);if(!h.ok){b("请先登录"),this.loginModal.open();return}this.renderLikes(h.count,h.action==="liked"),b(h.action==="liked"?"已点赞":"已取消点赞")}),r.appendChild(this.likeBtn),r.appendChild(this.likeCountEl),this.commentsEl=document.createElement("div"),this.commentsEl.className="vr-community-comments";const d=document.createElement("div");d.className="vr-community-inputrow",this.inputEl=document.createElement("input"),this.inputEl.className="vr-community-input",this.inputEl.type="text",this.inputEl.placeholder="写下你的想法…",this.inputEl.maxLength=120,this.inputEl.addEventListener("keydown",h=>{h.key==="Enter"&&this.handleSend()}),this.sendBtn=document.createElement("button"),this.sendBtn.className="vr-btn vr-community-send",this.sendBtn.textContent="发送",this.sendBtn.addEventListener("click",()=>this.handleSend()),d.appendChild(this.inputEl),d.appendChild(this.sendBtn),i.appendChild(a),i.appendChild(r),i.appendChild(this.commentsEl),i.appendChild(d),this.element.appendChild(e),this.element.appendChild(i),this.loginModal=new H({onLogin:()=>{this.refresh(),this.toast("登录成功")},onLogout:()=>{this.refresh()}}),document.body.appendChild(this.loginModal.getElement()),this.loginHintBtn.addEventListener("click",()=>this.loginModal.open()),this.setScene(t.sceneId,t.sceneName)}setScene(t,e){this.sceneId=t,this.sceneName=e,this.subtitleEl.textContent=this.sceneName?this.sceneName:t,this.refresh()}toastByReason(t){t==="not_logged_in"?b("请先登录"):t==="banned"?b("内容包含敏感词，已拦截"):t==="cooldown"?b("评论过于频繁，请稍后再试"):t==="EMPTY"&&b("内容不能为空")}formatRelativeTime(t){const e=Date.now()-t;if(e<6e4)return"刚刚";const s=Math.floor(e/6e4);if(s<60)return`${s} 分钟前`;const n=Math.floor(s/60);return n<24?`${n} 小时前`:new Date(t).toLocaleDateString("zh-CN",{month:"2-digit",day:"2-digit"})}renderLikes(t,e){this.likeCountEl.textContent=String(t),this.likeBtn.classList.toggle("liked",e)}renderComments(t){this.commentsEl.innerHTML="";const e=document.createElement("div");if(e.className="vr-community-tip",e.textContent="本场景最近 50 条留言",this.commentsEl.appendChild(e),!t.length){const n=document.createElement("div");n.className="vr-community-empty",n.textContent="此场景暂无留言",this.commentsEl.appendChild(n);return}let s=null;for(const n of t){const i=document.createElement("div");i.className="vr-community-comment";const a=document.createElement("div");a.className="vr-community-comment-meta",a.textContent=`${n.userName} · ${this.formatRelativeTime(n.ts)}`;const c=document.createElement("div");c.className="vr-community-comment-text",c.textContent=n.text,i.appendChild(a),i.appendChild(c),this.commentsEl.appendChild(i),s||(s=i)}s&&this.highlightNextFirstComment&&(s.classList.add("vr-community-comment--flash"),this.commentsEl.scrollTop=0,window.setTimeout(()=>{s==null||s.classList.remove("vr-community-comment--flash")},300)),this.highlightNextFirstComment=!1}handleSend(){const e=(this.inputEl.value||"").trim();if(!e){this.toastByReason("EMPTY");return}const s=I(this.sceneId,e);if(!s.ok){s.reason==="not_logged_in"?(this.toastByReason("not_logged_in"),this.loginModal.open()):this.toastByReason(s.reason);return}this.inputEl.value="",this.refresh(),this.highlightNextFirstComment=!0,b("评论已发布")}refresh(){const t=C();this.loginHintBtn.style.display=t?"none":"inline-flex",this.userLineEl.style.display=t?"flex":"none",this.userNameEl.textContent=t?t.name:"";const e=L(this.sceneId,(t==null?void 0:t.id)||"anon").count,s=t?L(this.sceneId,t.id).liked:!1;this.renderLikes(e,s),this.renderComments(O(this.sceneId));const n=!t;this.inputEl.disabled=n,this.sendBtn.classList.toggle("disabled",n)}getElement(){return this.element}remove(){this.loginModal.remove(),this.element.remove()}}const G=Object.freeze(Object.defineProperty({__proto__:null,CommunityPanel:U},Symbol.toStringTag,{value:"Module"}));export{G as C,J as F,j as f};
