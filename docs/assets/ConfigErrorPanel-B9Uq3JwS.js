var c=Object.defineProperty;var d=(a,e,r)=>e in a?c(a,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):a[e]=r;var s=(a,e,r)=>d(a,typeof e!="symbol"?e+"":e,r);import{E as p,a as m}from"./errorMessages-DgIuq_en.js";import"./index-CFOJI_Ry.js";import"./three-renderer-DNNhgqDo.js";class g{constructor(e,r,n){s(this,"element");this.element=document.createElement("div"),this.element.className="config-error-panel",this.render(e,r,n),this.applyStyles()}render(e,r,n){this.element.innerHTML=`
    ...
    `;const o=this.element.querySelector("#retry-btn"),t=this.element.querySelector("#example-btn");o&&o.addEventListener("click",r),t&&t.addEventListener("click",n)}renderErrorCard(e,r){const n=p[e.code]||"配置错误",o=m[e.code]||"请检查配置文件的格式和内容",t=[];e.museumName&&t.push(`馆：${e.museumName}`),e.sceneName&&t.push(`场景：${e.sceneName}`);const i=t.length>0?t.join(" / "):"全局配置";return`
    ...
    `,document.head.appendChild(e)}getElement(){return this.element}remove(){this.element.remove()}}export{g as ConfigErrorPanel};
