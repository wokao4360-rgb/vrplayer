...
void main() {
    ...
    `,document.head.appendChild(e)}getElement(){return this.element}remove(){this.element.remove()}}function Tv(s,e){const t=Pn.degToRad(s),n=Pn.degToRad(e),i=Math.cos(n)*Math.sin(t),r=Math.sin(n),a=Math.cos(n)*Math.cos(t);return new R(i,r,a)}function wv(s,e,t){const n=new R,i=new R;if(e.getWorldPosition(n),e.getWorldDirection(i),new R().copy(s).sub(n).dot(i)<=0)return{x:0,y:0,visible:!1};const a=new R().copy(s).project(e);if(!(a.x>=-1&&a.x<=1&&a.y>=-1&&a.y<=1&&a.z>=-1&&a.z<=1))return{x:0,y:0,visible:!1};const l=t.clientWidth,c=t.clientHeight,d=(a.x+1)*.5*l,h=(1-(a.y+1)*.5)*c;return{x:d,y:h,visible:!0}}function Av(s,e,t,n,i=500){const a=Tv(s,e).clone().multiplyScalar(i);return wv(a,t,n)}function Cv(){return`
...
<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  "museums": [
    ...
    `,this.appElement.appendChild(n);const i=sd();this.panoViewer=new Sv(n,i);try{this.topRightControls=new i_({viewerRootEl:n,onTogglePickMode:()=>this.panoViewer?(this.panoViewer.isPickModeEnabled()?this.panoViewer.disablePickMode():this.panoViewer.enablePickMode(),this.panoViewer.isPickModeEnabled()):!1,onOpenNorthCalibration:()=>{this.openNorthCalibration(t.id)},showNorthCalibration:!0}),this.appElement.appendChild(this.topRightControls.getElement())}catch(f){ft&&console.debug("[showScene] TopRightControls 创建失败，跳过:",f),this.topRightControls=null}this.sceneTitleEl=document.createElement("div"),this.sceneTitleEl.className="vr-scenetitle",this.sceneTitleEl.textContent=t.name||((m=this.config)==null?void 0:m.appName)||"VR Player",this.appElement.appendChild(this.sceneTitleEl);const r=f=>{const p=f,{x:S,y:x,yaw:w,pitch:L}=p.detail;if(jv({yaw:w,pitch:L,ts:Date.now()}),it(`已复制 yaw: ${w.toFixed(2)}, pitch: ${L.toFixed(2)}`),this.panoViewer){const A=this.panoViewer.getDomElement();U_(A,S,x)}};window.addEventListener("vr:pick",r);const a=f=>{const p=f;this.panoViewer&&!p.detail.enabled&&this.panoViewer.isPickModeEnabled()&&this.panoViewer.disablePickMode()};window.addEventListener("vr:pickmode",a);try{this.brandMark=new a_({appName:(v=this.config)==null?void 0:v.appName,brandText:"鼎虎清源"}),this.appElement.appendChild(this.brandMark.getElement())}catch(f){ft&&console.debug("[showScene] BrandMark 创建失败，跳过:",f),this.brandMark=null}if(i){this.debugPanel=new Yv,this.appElement.appendChild(this.debugPanel.getElement()),this.panoViewer.setOnDebugClick((p,S,x,w,L)=>{this.debugPanel&&this.debugPanel.show(p,S,x,w,L)});const f=()=>{if(this.debugPanel&&this.panoViewer){const p=this.panoViewer.getCurrentView();this.debugPanel.updateView(p.yaw,p.pitch,p.fov)}requestAnimationFrame(f)};f()}try{this.videoPlayer=new zv,this.appElement.appendChild(this.videoPlayer.getElement())}catch(f){ft&&console.debug("[showScene] VideoPlayer 创建失败，跳过:",f),this.videoPlayer=null}try{this.guideTray=new C_({museumId:e.id,currentSceneId:t.id,scenes:e.scenes,onSceneClick:f=>{$t(e.id,f)},onMoreClick:()=>{if(!this.sceneGuideDrawer)try{this.sceneGuideDrawer=new A_({museumId:e.id,currentSceneId:t.id,scenes:e.scenes,onClose:()=>{}}),this.appElement.appendChild(this.sceneGuideDrawer.getElement())}catch(f){ft&&console.debug("[GuideTray] SceneGuideDrawer 创建失败:",f)}this.guideTray&&this.guideTray.setVisible(!1),this.sceneGuideDrawer&&this.sceneGuideDrawer.open()},onClose:()=>{this.guideTray&&this.guideTray.setVisible(!1)}}),this.guideTray.setVisible(!1),this.appElement.appendChild(this.guideTray.getElement())}catch(f){ft&&console.debug("[showScene] GuideTray 创建失败，跳过:",f),this.guideTray=null}const o=new Map;e.scenes.forEach(f=>{let p;if(f.panoLow){const S=yn(f.panoLow,rn.PANO_LOW);S&&(p=S)}else if(f.pano){const S=yn(f.pano,rn.PANO);S&&(p=S)}o.set(f.id,{title:f.name,thumb:f.thumb,panoUrl:p})});try{this.bottomDock=new w_({initialTab:"guide",onGuideClick:()=>{this.guideTray&&this.guideTray.setVisible(!0)},sceneId:t.id,sceneName:t.name,museum:e,scenes:e.scenes,currentSceneId:t.id}),this.appElement.appendChild(this.bottomDock.getElement())}catch(f){ft&&console.debug("[showScene] BottomDock 创建失败，跳过:",f),this.bottomDock=null}try{this.topModeTabs=new I_({initialMode:this.mode,onModeChange:f=>{this.setMode(f)}}),this.appElement.appendChild(this.topModeTabs.getElement())}catch(f){ft&&console.debug("[showScene] TopModeTabs 创建失败，跳过:",f),this.topModeTabs=null}this.modeIndicatorEl=document.createElement("div"),this.modeIndicatorEl.className="vr-mode-indicator",this.modeIndicatorEl.textContent=`mode: ${this.mode}`,this.appElement.appendChild(this.modeIndicatorEl);try{const f=new Map(e.scenes.map(p=>[p.id,p.name]));this.hotspots=new Vv(this.panoViewer,t.hotspots,{resolveSceneName:p=>f.get(p),onEnterScene:p=>{$t(e.id,p)},museumId:e.id}),n.appendChild(this.hotspots.getElement())}catch(f){ft&&console.debug("[showScene] Hotspots 创建失败，跳过:",f),this.hotspots=null}try{this.qualityIndicator=new ov,this.appElement.appendChild(this.qualityIndicator.getElement())}catch(f){ft&&console.debug("[showScene] QualityIndicator 创建失败，跳过:",f),this.qualityIndicator=null}this.panoViewer.setOnStatusChange(f=>{this.qualityIndicator&&this.qualityIndicator.updateStatus(f)}),this.panoViewer.setOnLoad(()=>{this.loading.hide(),this.hideUIError(),this.preloadNextScene(e,t)}),this.panoViewer.setOnError(f=>{console.error("加载场景失败:",f),this.loading.hide(),this.showError("加载全景图失败，请检查网络连接"),this.qualityIndicator&&this.qualityIndicator.updateStatus(Pt.ERROR)});const l=Fa(),c=l.yaw!==void 0?l.yaw:t.initialView.yaw||0,d=l.pitch!==void 0?l.pitch:t.initialView.pitch||0,h=l.fov!==void 0?l.fov:t.initialView.fov||75,u=-c;this.panoViewer.setView(u,d,h),this.panoViewer.loadScene(t),this.panoViewer.setSceneData(e.id,t.id,t.hotspots);try{const f=(g=this.config)==null?void 0:g.fcChat;if(f!=null&&f.endpoint&&f.endpoint.trim()){const p={endpoint:f.endpoint,authToken:f.authToken,timeoutMs:15e3},S=new K_(p);this.fcChatPanel=new Y_(S,{museumId:e.id,sceneId:t.id,sceneTitle:t.name,museumName:e.name,url:window.location.href})}}catch(f){ft&&console.debug("[showScene] FcChatPanel 创建失败，跳过:",f),this.fcChatPanel=null}}preloadNextScene(e,t){const i=(e.scenes.findIndex(a=>a.id===t.id)+1)%e.scenes.length,r=e.scenes[i];r&&r.thumb&&zi(async()=>{const{resolveAssetUrl:a,AssetType:o}=await Promise.resolve().then(()=>av);return{resolveAssetUrl:a,AssetType:o}},void 0,import.meta.url).then(({resolveAssetUrl:a,AssetType:o})=>{const l=a(r.thumb,o.THUMB);if(l){const c=new Image;c.src=l}})}clearView(){this.panoViewer&&(this.panoViewer.dispose(),this.panoViewer=null),this.titleBar&&(this.titleBar.remove(),this.titleBar=null),this.topRightControls&&(this.topRightControls.remove(),this.topRightControls=null),this.northCalibrationPanel&&(this.northCalibrationPanel.close(),this.northCalibrationPanel=null),this.topModeTabs&&(this.topModeTabs.getElement().remove(),this.topModeTabs=null),this.sceneTitleEl&&(this.sceneTitleEl.remove(),this.sceneTitleEl=null),this.brandMark&&(this.brandMark.remove(),this.brandMark=null),this.bottomDock&&(this.bottomDock.remove(),this.bottomDock=null),this.guideTray&&(this.guideTray.remove(),this.guideTray=null),this.sceneGuideDrawer&&(this.sceneGuideDrawer.remove(),this.sceneGuideDrawer=null),this.museumList&&(this.museumList.remove(),this.museumList=null),this.sceneList&&(this.sceneList.remove(),this.sceneList=null),this.mapOverlay&&(this.mapOverlay.remove(),this.mapOverlay=null),this.hotspots&&(this.hotspots.remove(),this.hotspots=null),this.videoPlayer&&(this.videoPlayer.remove(),this.videoPlayer=null),this.controlBar&&(this.controlBar.remove(),this.controlBar=null),this.debugPanel&&(this.debugPanel.remove(),this.debugPanel=null),this.configStudio&&(this.configStudio.remove(),this.configStudio=null),this.qualityIndicator&&(this.qualityIndicator.remove(),this.qualityIndicator=null),this.modeIndicatorEl&&(this.modeIndicatorEl.remove(),this.modeIndicatorEl=null),this.structureView2D&&(this.structureView2D.remove(),this.structureView2D=null),this.structureView3D&&(this.structureView3D.remove(),this.structureView3D=null),this.fcChatPanel&&(this.fcChatPanel.remove(),this.fcChatPanel=null),this.mode="tour",this.appElement.innerHTML="",this.appElement.appendChild(this.loading.getElement())}hideUIError(){this.uiErrorElement&&this.uiErrorElement.parentNode&&(this.uiErrorElement.parentNode.removeChild(this.uiErrorElement),this.uiErrorElement=null)}setMode(e){if(this.mode!==e)if(this.mode=e,this.topModeTabs&&this.topModeTabs.setMode(e),this.modeIndicatorEl&&(this.modeIndicatorEl.textContent=`mode: ${e}`),e==="structure2d"||e==="structure3d"?document.body.style.overflow="hidden":document.body.style.overflow="",e==="structure2d"){if(!this.currentMuseum||!this.currentScene)return;this.structureView3D&&this.structureView3D.close();const t=Gl(this.currentMuseum,this.currentScene.id);this.structureView2D?this.structureView2D.updateContext({museum:this.currentMuseum,graph:t,currentSceneId:this.currentScene.id}):(this.structureView2D=new P_({museum:this.currentMuseum,graph:t,currentSceneId:this.currentScene.id,onNodeClick:(n,i)=>{this.setMode("tour"),$t(n,i)}}),this.appElement.appendChild(this.structureView2D.getElement())),this.structureView2D.open()}else if(e==="structure3d"){if(!this.currentMuseum||!this.currentScene)return;this.structureView2D&&this.structureView2D.close();const t=Gl(this.currentMuseum,this.currentScene.id);this.structureView3D?this.structureView3D.updateContext({museum:this.currentMuseum,graph:t,currentSceneId:this.currentScene.id}):(this.structureView3D=new D_({museum:this.currentMuseum,graph:t,currentSceneId:this.currentScene.id,onNodeClick:(n,i)=>{this.setMode("tour"),$t(n,i)}}),this.appElement.appendChild(this.structureView3D.getElement())),this.structureView3D.open()}else this.structureView2D&&this.structureView2D.close(),this.structureView3D&&this.structureView3D.close()}openNorthCalibration(e){if(this.northCalibrationPanel&&(this.northCalibrationPanel.close(),this.northCalibrationPanel=null),!this.panoViewer){console.warn("[openNorthCalibration] PanoViewer 未初始化");return}try{this.northCalibrationPanel=new W_({getCurrentYaw:()=>{var n;const t=(n=this.panoViewer)==null?void 0:n.getCurrentView();return(t==null?void 0:t.yaw)??0},sceneId:e,onClose:()=>{this.northCalibrationPanel=null}})}catch(t){console.error("[openNorthCalibration] 创建校准面板失败:",t),this.northCalibrationPanel=null}}showError(e){this.hideUIError(),this.uiErrorElement=document.createElement("div"),this.uiErrorElement.className="error-message",this.uiErrorElement.textContent=e,this.uiErrorElement.style.cssText=`
      ...
      text-align: center;
      max-width: 80vw;
    `,this.appElement.appendChild(this.uiErrorElement),setTimeout(()=>{this.hideUIError()},3e3)}}new Z_;export{l0 as $,da as A,Gt as B,ze as C,Cc as D,Mi as E,h0 as F,fa as G,tn as H,a0 as I,Ei as J,je as K,ji as L,Q_ as M,er as N,ct as O,Bn as P,Ti as Q,qi as R,g0 as S,e0 as T,Ut as U,R as V,r0 as W,ut as X,Pg as Y,ha as Z,o0 as _,De as a,mi as a0,Tt as a1,vc as a2,Tc as a3,d0 as a4,Cg as a5,Rs as a6,Ps as a7,Mc as a8,wt as a9,Bs as aa,ks as ab,$i as ac,Ke as ad,Rn as ae,qs as af,sn as ag,bn as ah,Pn as b,t0 as c,i0 as d,n0 as e,f0 as f,c0 as g,xn as h,ht as i,u0 as j,p0 as k,Ge as l,ml as m,Xg as n,m0 as o,s0 as p,Xn as q,Hd as r,Xa as s,Nt as t,yt as u,Wr as v,Yr as w,Kt as x,Ng as y,jn as z};
