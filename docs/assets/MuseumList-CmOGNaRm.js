var n=Object.defineProperty;var o=(i,t,s)=>t in i?n(i,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):i[t]=s;var a=(i,t,s)=>o(i,typeof t!="symbol"?t+"":t,s);import{k as u}from"./index-I51ows0J.js";class l{constructor(t){a(this,"element");a(this,"museums");this.museums=t,this.element=document.createElement("div"),this.element.className="museum-list",this.render(),this.applyStyles()}render(){const t=this.museums.filter(e=>e.id==="wangding"),s=this.museums.filter(e=>e.id!=="wangding");this.element.innerHTML=`
