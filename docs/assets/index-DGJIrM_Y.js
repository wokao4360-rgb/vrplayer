...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Rn,depthTest:!1,depthWrite:!1})}function al(){return new Zn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Sa(),fragmentShader:`
		...
		`,blending:Rn,depthTest:!1,depthWrite:!1})}function ol(){return new Zn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Sa(),fragmentShader:`
...
`)}function ng(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(yi).join(`
`)}function ig(s){const e=[];for(const t in s){const n=s[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function sg(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),a=r.name;let o=1;r.type===s.FLOAT_MAT2&&(o=2),r.type===s.FLOAT_MAT3&&(o=3),r.type===s.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:s.getAttribLocation(e,a),locationSize:o}}return t}function yi(s){return s!==""}function gl(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function vl(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const rg=/^[ \t]*#include +<([\w\d./]+)>/gm;function da(s){return s.replace(rg,og)}const ag=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function og(s,e){let t=De[e];if(t===void 0){const n=ag.get(e);if(n!==void 0)t=De[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return da(t)}const lg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function _l(s){return s.replace(lg,cg)}function cg(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function xl(s){let e="precision "+s.precision+` float;
precision `+s.precision+" int;";return s.precision==="highp"?e+=`
#define HIGH_PRECISION`:s.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:s.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function dg(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===ac?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Md?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===fn&&(e="SHADOWMAP_TYPE_VSM"),e}function hg(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Mi:case wi:e="ENVMAP_TYPE_CUBE";break;case tr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function ug(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case wi:e="ENVMAP_MODE_REFRACTION";break}return e}function pg(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case oc:e="ENVMAP_BLENDING_MULTIPLY";break;case $d:e="ENVMAP_BLENDING_MIX";break;case jd:e="ENVMAP_BLENDING_ADD";break}return e}function fg(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function mg(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=dg(t),c=hg(t),d=ug(t),h=pg(t),u=fg(t),f=t.isWebGL2?"":tg(t),v=ng(t),g=ig(r),m=i.createProgram();let p,S,x=t.glslVersion?"#version "+t.glslVersion+`
`:"";t.isRawShaderMaterial?(p=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,g].filter(yi).join(`
`),p.length>0&&(p+=`
`),S=[f,"#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,g].filter(yi).join(`
`),S.length>0&&(S+=`
...
void main() {
    ...
    `,document.head.appendChild(e)}}function Av(s=512){const e=document.createElement("canvas");e.width=s,e.height=s;const t=e.getContext("2d");if(!t){const c=new ua(e);return c.needsUpdate=!0,c}const n=s/2,i=s/2,r=s/2*.92;t.clearRect(0,0,s,s);const a=t.createRadialGradient(n,i,r*.25,n,i,r);a.addColorStop(0,"rgba(0,0,0,0.00)"),a.addColorStop(.55,"rgba(0,0,0,0.18)"),a.addColorStop(1,"rgba(0,0,0,0.55)"),t.fillStyle=a,t.beginPath(),t.arc(n,i,r,0,Math.PI*2),t.closePath(),t.fill(),t.fillStyle="rgba(0,0,0,0.55)",t.beginPath(),t.arc(n,i,r*.28,0,Math.PI*2),t.closePath(),t.fill();const o=t.createRadialGradient(n,i,0,n,i,r*.42);o.addColorStop(0,"rgba(0,0,0,0.22)"),o.addColorStop(1,"rgba(0,0,0,0.00)"),t.fillStyle=o,t.beginPath(),t.arc(n,i,r*.42,0,Math.PI*2),t.closePath(),t.fill(),t.save(),t.translate(n,i);for(let c=0;c<360;c+=30){const d=c*Math.PI/180,h=c%90===0,u=h?r*.12:r*.07,f=h?2:1;t.strokeStyle=h?"rgba(255,255,255,0.25)":"rgba(255,255,255,0.14)",t.lineWidth=f,t.beginPath(),t.moveTo(Math.sin(d)*(r-u),-Math.cos(d)*(r-u)),t.lineTo(Math.sin(d)*r,-Math.cos(d)*r),t.stroke()}t.restore(),t.strokeStyle="rgba(255,255,255,0.08)",t.lineWidth=2,t.beginPath(),t.arc(n,i,r,0,Math.PI*2),t.closePath(),t.stroke();const l=new ua(e);return l.colorSpace=dt,l.center.set(.5,.5),l.rotation=0,l.flipY=!1,l.needsUpdate=!0,l}const ut=typeof window<"u"?new URLSearchParams(window.location.search).get("debug")==="1":!1;function qe(...s){ut&&console.debug("[VR Debug]",...s)}function Cv(s){return Math.max(0,Math.min(1,s))}function Iv(s){const e=Cv(s);return e*e*(3-2*e)}class Lv{constructor(e,t){_(this,"mesh");_(this,"needleMesh",null);_(this,"texture");_(this,"radius");_(this,"opacity",0);_(this,"northYaw",0);_(this,"debugHelper",null);_(this,"labelSprites",new Map);_(this,"patchRadius",0);_(this,"showPitchDeg",-45);_(this,"fadeRangeDeg",18);_(this,"fadeTauMs",140);_(this,"lastRotationY",0);_(this,"debugFrameCount",0);_(this,"isDebugVisible",!0);this.radius=t;const n=t*.18;this.patchRadius=n;const i=new Aa(n,96);i.rotateX(Math.PI/2),this.texture=Av(512);const r=new Ci({map:this.texture,transparent:!0,opacity:0,depthTest:!1,depthWrite:!1,side:tn});this.mesh=new pt(i,r),this.mesh.name="NadirPatch-compass-disk",this.mesh.position.set(0,-t+.5,0),this.mesh.renderOrder=9999,this.mesh.visible=!1,this.mesh.rotation.y=0,e.add(this.mesh);const a=n*.008,o=n*.35,l=new Ca(a,a,o,8);l.rotateX(Math.PI/2),l.translate(0,0,o/2);const c=new Ci({color:16777215,transparent:!0,opacity:.9,depthTest:!1,depthWrite:!1});if(this.needleMesh=new pt(l,c),this.needleMesh.name="NadirPatch-compass-needle",this.needleMesh.position.set(0,-t+.51,0),this.needleMesh.rotation.order="YXZ",this.needleMesh.renderOrder=1e4,this.needleMesh.visible=!1,e.add(this.needleMesh),this.createLabelSprites(e,n,t),ut&&(r.color.setHex(65535),this.debugHelper=new Sv(n*.5),this.debugHelper.position.copy(this.mesh.position),this.debugHelper.renderOrder=10001,e.add(this.debugHelper),console.debug("[NadirPatch] 对象已创建:",{uuid:this.mesh.uuid,name:this.mesh.name,type:this.mesh.type,position:this.mesh.position,rotation:this.mesh.rotation})),typeof window<"u"){const d=h=>{(h.key==="N"||h.key==="n")&&!(h.target instanceof HTMLInputElement||h.target instanceof HTMLTextAreaElement)&&(h.preventDefault(),this.isDebugVisible=!this.isDebugVisible,this.mesh.visible=this.isDebugVisible&&this.opacity>.01,this.needleMesh&&(this.needleMesh.visible=this.isDebugVisible&&this.opacity>.01),this.debugHelper&&(this.debugHelper.visible=this.isDebugVisible&&this.opacity>.01),console.debug(`[NadirPatch] 显示状态切换为: ${this.isDebugVisible?"显示":"隐藏"}`))};window.addEventListener("keydown",d)}}setNorthYaw(e){this.northYaw=e}update(e,t,n){var f;const i=t.yaw,r=this.northYaw??0,a=xn.degToRad(-r);this.mesh.rotation.y=a,this.texture.rotation=0,this.texture.center.set(.5,.5);const o=-r;this.updateLabelSprites(o),this.needleMesh&&(this.needleMesh.rotation.y=xn.degToRad(i)),ut&&(this.debugFrameCount++,this.debugFrameCount%30===0&&(Math.abs(this.mesh.rotation.y-this.lastRotationY)>.001&&console.debug("[NadirPatch] 旋转变化:",{frame:this.debugFrameCount,cameraYaw:i.toFixed(2),northYaw:r.toFixed(2),needleYaw:i.toFixed(2),diskRotationY:this.mesh.rotation.y,needleRotationY:(f=this.needleMesh)==null?void 0:f.rotation.y,diskPosition:this.mesh.position}),this.lastRotationY=this.mesh.rotation.y));const c=Iv((this.showPitchDeg-t.pitch)/this.fadeRangeDeg),d=1-Math.exp(-(n||16.7)/this.fadeTauMs);this.opacity=this.opacity+(c-this.opacity)*d;const h=this.mesh.material;h.opacity=this.opacity;const u=this.isDebugVisible&&this.opacity>.01;if(this.mesh.visible=u,this.needleMesh){this.needleMesh.visible=u;const v=this.needleMesh.material;v.opacity=this.opacity*.9}this.labelSprites.forEach(v=>{v.visible=u;const g=v.material;g.opacity=this.opacity*.85}),this.debugHelper&&(this.debugHelper.visible=u)}createLabelSprites(e,t,n){[{text:"北",baseAngle:0},{text:"东",baseAngle:270},{text:"南",baseAngle:180},{text:"西",baseAngle:90}].forEach(({text:r})=>{const a=document.createElement("canvas"),o=128;a.width=o,a.height=o;const l=a.getContext("2d");if(!l)return;l.clearRect(0,0,o,o),l.save(),l.shadowColor="rgba(255, 255, 255, 0.8)",l.shadowBlur=8,l.shadowOffsetX=0,l.shadowOffsetY=0,l.fillStyle="rgba(255, 255, 255, 0.85)",l.font=`600 ${Math.round(o*.5)}px system-ui, -apple-system, Segoe UI, PingFang SC, Microsoft YaHei, sans-serif`,l.textAlign="center",l.textBaseline="middle",l.fillText(r,o/2,o/2),l.restore();const c=new ua(a);c.colorSpace=dt,c.needsUpdate=!0;const d=new kc({map:c,transparent:!0,opacity:0,depthTest:!1,depthWrite:!1}),h=new Wg(d);h.name=`NadirPatch-label-${r}`,h.position.set(0,-n+.52,0),h.renderOrder=10001,h.visible=!1;const u=t*.15;h.scale.set(u,u,1),e.add(h),this.labelSprites.set(r,h)})}updateLabelSprites(e){[{text:"北",baseAngle:0},{text:"东",baseAngle:270},{text:"南",baseAngle:180},{text:"西",baseAngle:90}].forEach(({text:n,baseAngle:i})=>{const r=this.labelSprites.get(n);if(!r)return;const a=i+e,o=this.patchRadius*.56,l=xn.degToRad(a),c=-this.radius+.5,d=Math.sin(l)*o,h=Math.cos(l)*o;r.position.set(d,c+.02,h);const u=new L(0,0,0);r.lookAt(u)})}dispose(e){e.remove(this.mesh),this.mesh.geometry.dispose(),this.mesh.material.dispose(),this.texture.dispose(),this.needleMesh&&(e.remove(this.needleMesh),this.needleMesh.geometry.dispose(),this.needleMesh.material.dispose()),this.labelSprites.forEach(t=>{e.remove(t),t.material.dispose(),t.material.map&&t.material.map.dispose()}),this.labelSprites.clear(),this.debugHelper&&(e.remove(this.debugHelper),this.debugHelper.dispose())}}function Rv(s,e,t){const n=(s-t.left)/t.width*2-1,i=-((e-t.top)/t.height*2-1);return{x:n,y:i}}function Pv(s,e,t,n=500){const i=new Qi;i.setFromCamera(new Se(s,e),t);const r=i.ray.direction;if(!r||r.length()===0)return null;const a=r.normalize(),o=Math.asin(Math.max(-1,Math.min(1,a.y))),l=xn.radToDeg(o),c=Math.atan2(a.x,a.z);return{yaw:xn.radToDeg(c),pitch:l}}const fa=-55,Nv=-90;function Na(s){const e=Math.max(0,Math.min(1,(s-fa)/(Nv-fa))),t=e,n=-e*8,i=1-e*.7,r=e*2;return{opacity:t,translateY:n,scaleY:i,blur:r,clarity:e}}function Da(s){return s<=fa}class Dv{constructor(){_(this,"listeners",new Map);_(this,"lastInteractionTs",0);_(this,"idleDelay",800);_(this,"idleTimer",null);_(this,"rafId",null);_(this,"isScheduled",!1);this.listeners.set("user-interacting",new Set),this.listeners.set("user-idle",new Set),this.listeners.set("ui-engaged",new Set)}on(e,t){const n=this.listeners.get(e);return n?(n.add(t),()=>{n.delete(t)}):(console.warn(`[InteractionBus] 未知事件类型: ${e}`),()=>{})}off(e,t){const n=this.listeners.get(e);n&&n.delete(t)}emit(e){this.isScheduled||(this.isScheduled=!0,this.rafId=requestAnimationFrame(()=>{this.isScheduled=!1;const t=this.listeners.get(e);t&&t.forEach(n=>{try{n()}catch(i){console.error("[InteractionBus] 事件监听器执行失败:",i)}})}))}emitInteracting(){this.lastInteractionTs=Date.now(),this.idleTimer!==null&&(clearTimeout(this.idleTimer),this.idleTimer=null),this.emit("user-interacting")}scheduleIdle(){this.idleTimer!==null&&(clearTimeout(this.idleTimer),this.idleTimer=null),this.idleTimer=window.setTimeout(()=>{Date.now()-this.lastInteractionTs>=this.idleDelay&&(this.idleTimer=null,this.emit("user-idle"))},this.idleDelay)}emitUIEngaged(){this.lastInteractionTs=Date.now(),this.idleTimer!==null&&(clearTimeout(this.idleTimer),this.idleTimer=null),this.emit("ui-engaged")}dispose(){this.idleTimer!==null&&(clearTimeout(this.idleTimer),this.idleTimer=null),this.rafId!==null&&(cancelAnimationFrame(this.rafId),this.rafId=null),this.listeners.forEach(e=>e.clear()),this.listeners.clear()}}const it=new Dv;class Uv{constructor(e={}){_(this,"root");_(this,"disk");_(this,"mask");_(this,"polemask");_(this,"northLabel");_(this,"eastLabel");_(this,"southLabel");_(this,"westLabel");_(this,"needle");_(this,"currentYaw",0);_(this,"currentPitch",0);_(this,"northYaw",0);_(this,"sceneId","");_(this,"northYawLabel",null);_(this,"isVisible",!1);_(this,"unsubscribeInteracting",null);_(this,"unsubscribeIdle",null);_(this,"unsubscribeUIEngaged",null);_(this,"baseOpacity",0);this.root=document.createElement("div"),this.root.className="vr-compass",this.root.setAttribute("data-ui","CompassDisk"),this.root.style.outline="2px solid #ff00ff",this.disk=document.createElement("div"),this.disk.className="vr-compass__disk",this.disk.setAttribute("data-ui","CompassDisk-disk"),this.mask=document.createElement("div"),this.mask.className="vr-compass__mask",this.polemask=document.createElement("div"),this.polemask.className="vr-compass__polemask",this.polemask.setAttribute("aria-hidden","true"),this.northLabel=document.createElement("div"),this.northLabel.className="vr-compass__label vr-compass__label--north",this.northLabel.textContent="北",this.eastLabel=document.createElement("div"),this.eastLabel.className="vr-compass__label vr-compass__label--east",this.eastLabel.textContent="东",this.southLabel=document.createElement("div"),this.southLabel.className="vr-compass__label vr-compass__label--south",this.southLabel.textContent="南",this.westLabel=document.createElement("div"),this.westLabel.className="vr-compass__label vr-compass__label--west",this.westLabel.textContent="西",this.needle=document.createElement("div"),this.needle.className="vr-compass__needle",this.needle.setAttribute("data-ui","CompassDisk-needle"),this.northYawLabel=document.createElement("div"),this.northYawLabel.className="vr-compass__north-yaw-label",this.northYawLabel.style.cssText=`
      position: absolute;
      bottom: -20px;
      right: 10px;
      font-size: 10px;
...
<svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M12 4v16M12 4l6 6M12 4l-6 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    `,document.head.appendChild(e)}getElement(){return this.element}remove(){this.element.remove()}}class l_{constructor(){_(this,"element");this.element=document.createElement("div"),this.element.className="loading-overlay",this.render(),this.applyStyles();const e=()=>{Js()&&this.hide()};document.addEventListener("fullscreenchange",e),document.addEventListener("webkitfullscreenchange",e)}render(){this.element.innerHTML=`
    ...
    `,document.head.appendChild(e)}getElement(){return this.element}remove(){this.element.remove()}}const Oa="vrplayer_config_draft_v1";function Zl(){try{const s=localStorage.getItem(Oa);return s?JSON.parse(s):null}catch(s){return console.warn("加载草稿失败",s),null}}function h_(s){try{const e=JSON.stringify(s);return localStorage.setItem(Oa,e),{ok:!0}}catch(e){return console.warn("保存草稿失败",e),{ok:!1,reason:e instanceof Error?e.message:"unknown"}}}function u_(){try{localStorage.removeItem(Oa)}catch(s){console.warn("清空草稿失败",s)}}const Kc="vr_last_pick_v1";let Fa=null;function p_(){try{const s=localStorage.getItem(Kc);if(s){const e=JSON.parse(s);typeof e.yaw=="number"&&typeof e.pitch=="number"&&typeof e.ts=="number"&&(Fa=e)}}catch{}}p_();function f_(s){Fa=s;try{localStorage.setItem(Kc,JSON.stringify(s))}catch{}}function Jl(){return Fa}const Ql="vrplayer_config_draft_ignore_session";class m_{constructor(e,t){_(this,"element");_(this,"config");_(this,"initialConfig");_(this,"editingTarget",{type:"global"});_(this,"simpleMode",!0);_(this,"validationErrors",[]);_(this,"validationDebounceTimer",null);_(this,"draftSaveTimer",null);_(this,"draftLoaded",!1);_(this,"draftIgnoreSession",!1);_(this,"draftBannerMessage",null);_(this,"onConfigChange");this.config=JSON.parse(JSON.stringify(e)),this.initialConfig=JSON.parse(JSON.stringify(e)),this.onConfigChange=t;try{this.draftIgnoreSession=sessionStorage.getItem(Ql)==="1"}catch(n){console.warn("读取草稿忽略状态失败",n),this.draftIgnoreSession=!1}this.tryRestoreDraft(),this.element=document.createElement("div"),this.element.className="config-studio",this.render(),this.applyStyles(),this.renderDraftBanner(),this.validateConfig()}tryRestoreDraft(){if(this.draftIgnoreSession)return;const e=Zl();e&&(this.config=JSON.parse(JSON.stringify(e)),this.draftLoaded=!0,this.draftBannerMessage="检测到未导出的草稿，已自动恢复。",this.onConfigChange&&this.onConfigChange(this.config))}renderDraftBanner(){const e=this.element.querySelector("#draft-banner");if(!e)return;if(!this.draftLoaded||this.draftIgnoreSession){e.innerHTML="",e.style.display="none";return}const t=this.draftBannerMessage||"检测到未导出的草稿，已自动恢复。";e.innerHTML=`
    ...
    `,document.head.appendChild(e)}}let Cn=null;function g_(){return Cn!==null?Cn:typeof navigator<"u"&&navigator.maxTouchPoints>0||typeof window<"u"&&("ontouchstart"in window||window.DocumentTouch&&document instanceof window.DocumentTouch)?(Cn="touch",Cn):(Cn="mouse",Cn)}function v_(){return g_()==="mouse"}function __(){const s=document;return document.fullscreenElement||s.webkitFullscreenElement||null}function Qs(){return!!__()}async function x_(s){const e=s;if(e.requestFullscreen){await e.requestFullscreen();return}if(e.webkitRequestFullscreen){await e.webkitRequestFullscreen();return}throw new Error("Fullscreen API not supported")}async function y_(){const s=document;if(document.exitFullscreen){await document.exitFullscreen();return}if(s.webkitExitFullscreen){await s.webkitExitFullscreen();return}}async function b_(s){const e=s||document.body;!Qs()&&v_()&&nt("鼠标滑至最上方可退出全屏",700),await x_(e)}async function E_(){try{await y_(),Zc()}catch(s){console.debug("[fullscreen] exitFullscreenBestEffort failed:",s)}}function Zc(){var s,e;try{(e=(s=screen.orientation)==null?void 0:s.unlock)==null||e.call(s)}catch{}}function S_(){return`
...
<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M15 15l3 3" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    `,document.head.appendChild(e)}getElement(){return this.root}remove(){this.destroy()}}function p0(s){try{return JSON.parse(s)}catch{return null}}function Jr(s){return typeof s=="string"?s:""}function f0(s){return s.endsWith("/")?s:s+"/"}function m0(s,e){const t={question:s};return e&&typeof e=="object"&&(t.context={museumId:e.museumId||"",museumName:e.museumName||"",sceneId:e.sceneId||"",sceneTitle:e.sceneTitle||"",url:e.url||""}),t}function g0(s){if(s&&typeof s=="object"&&typeof s.answer=="string"&&s.answer.trim())return{ok:!0,answer:s.answer.trim(),model:Jr(s.model)||void 0};if(s&&typeof s=="object"&&("code"in s||"msg"in s||"data"in s)){const e=typeof s.code=="number"?s.code:void 0,t=Jr(s.msg)||"",n=s.data;if((e===0||e===void 0)&&n&&typeof n=="object"){const i=typeof n.answer=="string"?n.answer.trim():"";if(i)return{ok:!0,answer:i,model:Jr(n.model)||void 0}}if(e===40101||t.toLowerCase()==="unauthorized")return{ok:!1,code:40101,msg:"unauthorized"};if(e!==void 0&&e!==0)return{ok:!1,code:e,msg:t||`error code=${e}`};if(t&&t.toLowerCase()!=="ok")return{ok:!1,code:e,msg:t}}return{ok:!1,msg:"bad response"}}class v0{constructor(e){_(this,"endpoint");_(this,"authToken");_(this,"timeoutMs");if(!(e!=null&&e.endpoint))throw new Error("fcChat endpoint is empty");this.endpoint=f0(e.endpoint),this.authToken=e.authToken||"",this.timeoutMs=typeof e.timeoutMs=="number"&&e.timeoutMs>0?e.timeoutMs:15e3}async ask(e,t){const n=(e||"").trim();if(!n)throw new Error("empty question");const i=new AbortController,r=setTimeout(()=>i.abort(),this.timeoutMs);try{const a={"Content-Type":"application/json"};this.authToken&&(a.Authorization=this.authToken.startsWith("Bearer ")?this.authToken:`Bearer ${this.authToken}`);const o=await fetch(this.endpoint,{method:"POST",headers:a,body:JSON.stringify(m0(n,t)),signal:i.signal}),l=await o.text(),c=p0(l);if(!c){const u=l?`bad response: ${l}`:`http ${o.status}`;throw new Error(u)}const d=g0(c);if(d.ok)return{answer:d.answer,model:d.model};if(d.code===40101){const u=new Error("unauthorized (code=40101)");throw u.code=40101,u}const h=d.code?`${d.msg} (code=${d.code})`:d.msg;throw new Error(h||"request failed")}catch(a){throw(a==null?void 0:a.name)==="AbortError"?new Error(`timeout (${this.timeoutMs}ms)`):a}finally{clearTimeout(r)}}}ut&&(window.__vrDump=()=>{const s=c0();return console.debug("[VR State Snapshot]",s),s},window.__vrResetUI=()=>{console.debug("[VR Reset UI] 正在清理所有 UI 状态..."),d0(it),console.debug("[VR Reset UI] 清理完成")},console.debug("[VR Debug] 调试模式已启用。使用 __vrDump() 查看状态，使用 __vrResetUI() 复位 UI"));_d();o0();l0();wv();const ad=()=>{const s=document;!!(document.fullscreenElement||s.webkitFullscreenElement)&&t_()};document.addEventListener("fullscreenchange",ad);document.addEventListener("webkitfullscreenchange",ad);function _0(){const s=new URLSearchParams(location.search);return s.has("development")||s.get("dev")==="1"||location.hash.includes("development")}class x0{constructor(){_(this,"appElement");_(this,"config",null);_(this,"panoViewer",null);_(this,"titleBar",null);_(this,"topRightControls",null);_(this,"topModeTabs",null);_(this,"sceneTitleEl",null);_(this,"brandMark",null);_(this,"bottomDock",null);_(this,"sceneGuideDrawer",null);_(this,"guideTray",null);_(this,"museumList",null);_(this,"sceneList",null);_(this,"mapOverlay",null);_(this,"hotspots",null);_(this,"videoPlayer",null);_(this,"controlBar",null);_(this,"loading");_(this,"debugPanel",null);_(this,"configStudio",null);_(this,"qualityIndicator",null);_(this,"northCalibrationPanel",null);_(this,"currentMuseum",null);_(this,"currentScene",null);_(this,"hasBoundFullscreenEvents",!1);_(this,"mode","tour");_(this,"isStructureOverlayOpen",!1);_(this,"structureView2D",null);_(this,"structureView3D",null);_(this,"fcChatPanel",null);_(this,"uiErrorElement",null);const e=document.getElementById("app");if(!e)throw new Error("找不到 #app 元素");this.appElement=e,qc(),this.loading=new l_,this.appElement.appendChild(this.loading.getElement()),this.bindFullscreenEventsOnce(),this.init()}bindFullscreenEventsOnce(){if(this.hasBoundFullscreenEvents)return;this.hasBoundFullscreenEvents=!0;const e=()=>{var t;(t=this.topRightControls)==null||t.syncFullscreenState(),Qs()||Zc()};document.addEventListener("fullscreenchange",e),document.addEventListener("webkitfullscreenchange",e)}async init(){try{if(this.loading.show(),bd()){await this.initEditorMode(),this.loading.hide();return}this.config=await qa(),this.titleBar&&this.titleBar.setTitle(this.config.appName),window.addEventListener("popstate",()=>this.handleRoute()),await this.handleRoute(),this.loading.hide()}catch(e){console.error("配置加载失败:",e),this.loading.hide(),e.validationErrors&&Array.isArray(e.validationErrors)?this.showConfigErrorPanel(e.validationErrors):this.showError("加载配置失败，请刷新页面重试")}}async initEditorMode(){try{this.config=await qa(),this.appElement.innerHTML="",this.configStudio=new m_(this.config,e=>{this.config=e,$a()}),this.appElement.appendChild(this.configStudio.getElement())}catch(e){console.error("初始化编辑器模式失败:",e),e.validationErrors&&Array.isArray(e.validationErrors)?this.showConfigErrorPanel(e.validationErrors):this.showError("加载配置失败，请刷新页面重试")}}showConfigErrorPanel(e){this.appElement.innerHTML="";const t=new c_(e,()=>{$a(),window.location.reload()},()=>{this.showConfigExample()});this.appElement.appendChild(t.getElement())}showConfigExample(){const e=window.open("","_blank");e&&e.document.write(`
        <!DOCTYPE html>
        <html lang="zh-CN">
        <head>
          <meta charset="UTF-8">
  ...
  "museums": [
    ...
    `,this.appElement.appendChild(n);const i=yd();this.panoViewer=new Vv(n,i);const r=_0();try{this.topRightControls=new w_({viewerRootEl:n,onTogglePickMode:r?()=>this.panoViewer?(this.panoViewer.isPickModeEnabled()?this.panoViewer.disablePickMode():this.panoViewer.enablePickMode(),this.panoViewer.isPickModeEnabled()):!1:void 0,onOpenNorthCalibration:r?()=>{this.openNorthCalibration(t.id)}:void 0,showNorthCalibration:r}),this.appElement.appendChild(this.topRightControls.getElement())}catch(p){ut&&console.debug("[showScene] TopRightControls 创建失败，跳过:",p),this.topRightControls=null}this.sceneTitleEl=document.createElement("div"),this.sceneTitleEl.className="vr-scenetitle",this.sceneTitleEl.textContent=t.name||((v=this.config)==null?void 0:v.appName)||"VR Player",this.appElement.appendChild(this.sceneTitleEl);const a=p=>{const S=p,{x,y:T,yaw:R,pitch:A}=S.detail;if(f_({yaw:R,pitch:A,ts:Date.now()}),nt(`已复制 yaw: ${R.toFixed(2)}, pitch: ${A.toFixed(2)}`),this.panoViewer){const C=this.panoViewer.getDomElement();n0(C,x,T)}};window.addEventListener("vr:pick",a);const o=p=>{const S=p;this.panoViewer&&!S.detail.enabled&&this.panoViewer.isPickModeEnabled()&&this.panoViewer.disablePickMode()};window.addEventListener("vr:pickmode",o);try{this.appElement.querySelector(".vr-brandmark")?ut&&console.debug("[showScene] BrandMark 已存在，跳过重复创建"):(this.brandMark=new A_({appName:(g=this.config)==null?void 0:g.appName,brandText:"鼎虎清源"}),this.appElement.appendChild(this.brandMark.getElement()))}catch(p){ut&&console.debug("[showScene] BrandMark 创建失败，跳过:",p),this.brandMark=null}if(i){this.debugPanel=new d_,this.appElement.appendChild(this.debugPanel.getElement()),this.panoViewer.setOnDebugClick((S,x,T,R,A)=>{this.debugPanel&&this.debugPanel.show(S,x,T,R,A)});const p=()=>{if(this.debugPanel&&this.panoViewer){const S=this.panoViewer.getCurrentView();this.debugPanel.updateView(S.yaw,S.pitch,S.fov)}requestAnimationFrame(p)};p()}try{this.videoPlayer=new o_,this.appElement.appendChild(this.videoPlayer.getElement())}catch(p){ut&&console.debug("[showScene] VideoPlayer 创建失败，跳过:",p),this.videoPlayer=null}try{this.guideTray=new j_({museumId:e.id,currentSceneId:t.id,scenes:e.scenes,onSceneClick:p=>{jt(e.id,p)},onMoreClick:()=>{if(!this.sceneGuideDrawer)try{this.sceneGuideDrawer=new $_({museumId:e.id,currentSceneId:t.id,scenes:e.scenes,onClose:()=>{}}),this.appElement.appendChild(this.sceneGuideDrawer.getElement())}catch(p){ut&&console.debug("[GuideTray] SceneGuideDrawer 创建失败:",p)}this.guideTray&&this.guideTray.setVisible(!1),this.sceneGuideDrawer&&this.sceneGuideDrawer.open()},onClose:()=>{this.guideTray&&this.guideTray.setVisible(!1)}}),this.guideTray.setVisible(!1),this.appElement.appendChild(this.guideTray.getElement())}catch(p){ut&&console.debug("[showScene] GuideTray 创建失败，跳过:",p),this.guideTray=null}const l=new Map;e.scenes.forEach(p=>{let S;if(p.panoLow){const x=bn(p.panoLow,rn.PANO_LOW);x&&(S=x)}else if(p.pano){const x=bn(p.pano,rn.PANO);x&&(S=x)}l.set(p.id,{title:p.name,thumb:p.thumb,panoUrl:S})});try{this.bottomDock=new q_({initialTab:"guide",onGuideClick:()=>{this.guideTray&&this.guideTray.setVisible(!0)},sceneId:t.id,sceneName:t.name,museum:e,scenes:e.scenes,currentSceneId:t.id}),this.appElement.appendChild(this.bottomDock.getElement())}catch(p){ut&&console.debug("[showScene] BottomDock 创建失败，跳过:",p),this.bottomDock=null}try{this.topModeTabs=new K_({initialMode:this.mode,onModeChange:p=>{this.setMode(p)}}),this.appElement.appendChild(this.topModeTabs.getElement())}catch(p){ut&&console.debug("[showScene] TopModeTabs 创建失败，跳过:",p),this.topModeTabs=null}try{const p=new Map(e.scenes.map(S=>[S.id,S.name]));this.hotspots=new a_(this.panoViewer,t.hotspots,{resolveSceneName:S=>p.get(S),onEnterScene:S=>{jt(e.id,S)},museumId:e.id}),n.appendChild(this.hotspots.getElement())}catch(p){ut&&console.debug("[showScene] Hotspots 创建失败，跳过:",p),this.hotspots=null}try{this.qualityIndicator=new Tv,this.appElement.appendChild(this.qualityIndicator.getElement())}catch(p){ut&&console.debug("[showScene] QualityIndicator 创建失败，跳过:",p),this.qualityIndicator=null}this.panoViewer.setOnStatusChange(p=>{this.qualityIndicator&&this.qualityIndicator.updateStatus(p)}),this.panoViewer.setOnLoad(()=>{this.loading.hide(),this.hideUIError(),this.preloadNextScene(e,t)}),this.panoViewer.setOnError(p=>{console.error("加载场景失败:",p),this.loading.hide(),this.showError("加载全景图失败，请检查网络连接"),this.qualityIndicator&&this.qualityIndicator.updateStatus(Pt.ERROR)});const c=Za(),d=c.yaw!==void 0?c.yaw:t.initialView.yaw||0,h=c.pitch!==void 0?c.pitch:t.initialView.pitch||0,u=c.fov!==void 0?c.fov:t.initialView.fov||75,f=-d;this.panoViewer.setView(f,h,u),this.panoViewer.loadScene(t),this.panoViewer.setSceneData(e.id,t.id,t.hotspots);try{const p=(m=this.config)==null?void 0:m.fcChat;if(p!=null&&p.endpoint&&p.endpoint.trim()){const S={endpoint:p.endpoint,authToken:p.authToken,timeoutMs:15e3},x=new v0(S);this.fcChatPanel=new u0(x,{museumId:e.id,sceneId:t.id,sceneTitle:t.name,museumName:e.name,url:window.location.href})}}catch(p){ut&&console.debug("[showScene] FcChatPanel 创建失败，跳过:",p),this.fcChatPanel=null}}preloadNextScene(e,t){const i=(e.scenes.findIndex(a=>a.id===t.id)+1)%e.scenes.length,r=e.scenes[i];r&&r.thumb&&Hs(async()=>{const{resolveAssetUrl:a,AssetType:o}=await Promise.resolve().then(()=>Mv);return{resolveAssetUrl:a,AssetType:o}},void 0,import.meta.url).then(({resolveAssetUrl:a,AssetType:o})=>{const l=a(r.thumb,o.THUMB);if(l){const c=new Image;c.src=l}})}clearView(){if(this.panoViewer&&(this.panoViewer.dispose(),this.panoViewer=null),this.titleBar&&(this.titleBar.remove(),this.titleBar=null),this.topRightControls&&(this.topRightControls.remove(),this.topRightControls=null),this.northCalibrationPanel&&(this.northCalibrationPanel.close(),this.northCalibrationPanel=null),this.topModeTabs&&(this.topModeTabs.getElement().remove(),this.topModeTabs=null),this.sceneTitleEl&&(this.sceneTitleEl.remove(),this.sceneTitleEl=null),this.brandMark&&(this.brandMark.remove(),this.brandMark=null),this.bottomDock&&(this.bottomDock.remove(),this.bottomDock=null),this.guideTray&&(this.guideTray.remove(),this.guideTray=null),this.sceneGuideDrawer&&(this.sceneGuideDrawer.remove(),this.sceneGuideDrawer=null),this.museumList&&(this.museumList.remove(),this.museumList=null),this.sceneList&&(this.sceneList.remove(),this.sceneList=null),this.mapOverlay&&(this.mapOverlay.remove(),this.mapOverlay=null),this.hotspots&&(this.hotspots.remove(),this.hotspots=null),this.videoPlayer&&(this.videoPlayer.remove(),this.videoPlayer=null),this.controlBar&&(this.controlBar.remove(),this.controlBar=null),this.debugPanel&&(this.debugPanel.remove(),this.debugPanel=null),this.configStudio&&(this.configStudio.remove(),this.configStudio=null),this.qualityIndicator&&(this.qualityIndicator.remove(),this.qualityIndicator=null),this.structureView2D){const e=this.structureView2D.getElement();e&&e.parentNode&&e.parentNode.removeChild(e),this.structureView2D=null}if(this.structureView3D){const e=this.structureView3D.getElement();e&&e.parentNode&&e.parentNode.removeChild(e),this.structureView3D=null}this.isStructureOverlayOpen=!1,this.fcChatPanel&&(this.fcChatPanel.remove(),this.fcChatPanel=null),this.mode="tour",this.appElement.innerHTML="",this.appElement.appendChild(this.loading.getElement())}hideUIError(){this.uiErrorElement&&this.uiErrorElement.parentNode&&(this.uiErrorElement.parentNode.removeChild(this.uiErrorElement),this.uiErrorElement=null)}setMode(e){this.mode!==e&&(this.mode,this.mode=e,this.topModeTabs&&this.topModeTabs.setMode(e),e==="tour"&&this.isStructureOverlayOpen&&this.closeStructureOverlay({toTour:!1}),e==="structure2d"?this.openStructure2D():e==="structure3d"&&this.openStructure3D())}openStructure2D(){if(!this.currentMuseum||!this.currentScene)return;this.isStructureOverlayOpen&&this.closeStructureOverlay({toTour:!1});const e=ic(this.currentMuseum,this.currentScene.id);this.structureView2D?this.structureView2D.updateContext({museum:this.currentMuseum,graph:e,currentSceneId:this.currentScene.id}):(this.structureView2D=new Q_({museum:this.currentMuseum,graph:e,currentSceneId:this.currentScene.id,onClose:()=>{this.closeStructureOverlay({toTour:!0})},onNodeClick:(t,n)=>{this.closeStructureOverlay({toTour:!1}),jt(t,n)}}),this.appElement.appendChild(this.structureView2D.getElement())),this.isStructureOverlayOpen=!0,document.body.style.overflow="hidden",this.structureView2D.open()}openStructure3D(){if(!this.currentMuseum||!this.currentScene)return;this.isStructureOverlayOpen&&this.closeStructureOverlay({toTour:!1});const e=ic(this.currentMuseum,this.currentScene.id);this.structureView3D?this.structureView3D.updateContext({museum:this.currentMuseum,graph:e,currentSceneId:this.currentScene.id}):(this.structureView3D=new t0({museum:this.currentMuseum,graph:e,currentSceneId:this.currentScene.id,onClose:()=>{this.closeStructureOverlay({toTour:!0})},onNodeClick:(t,n)=>{this.closeStructureOverlay({toTour:!1}),jt(t,n)}}),this.appElement.appendChild(this.structureView3D.getElement())),this.isStructureOverlayOpen=!0,document.body.style.overflow="hidden",this.structureView3D.open()}closeStructureOverlay(e){if(this.isStructureOverlayOpen){if(this.isStructureOverlayOpen=!1,this.structureView2D){const t=this.structureView2D.getElement();t&&t.parentNode&&t.parentNode.removeChild(t),this.structureView2D=null}if(this.structureView3D){const t=this.structureView3D.getElement();t&&t.parentNode&&t.parentNode.removeChild(t),this.structureView3D=null}document.body.style.overflow="",document.body.style.touchAction="",document.body.style.overscrollBehavior="",e.toTour&&(this.mode="tour",this.topModeTabs&&this.topModeTabs.setMode("tour"))}}openNorthCalibration(e){if(this.northCalibrationPanel&&(this.northCalibrationPanel.close(),this.northCalibrationPanel=null),!this.panoViewer){console.warn("[openNorthCalibration] PanoViewer 未初始化");return}try{this.northCalibrationPanel=new h0({getCurrentYaw:()=>{var n;const t=(n=this.panoViewer)==null?void 0:n.getCurrentView();return(t==null?void 0:t.yaw)??0},sceneId:e,onClose:()=>{this.northCalibrationPanel=null}})}catch(t){console.error("[openNorthCalibration] 创建校准面板失败:",t),this.northCalibrationPanel=null}}showError(e){this.hideUIError(),this.uiErrorElement=document.createElement("div"),this.uiErrorElement.className="error-message",this.uiErrorElement.textContent=e,this.uiErrorElement.style.cssText=`
      ...
      text-align: center;
      max-width: 80vw;
    `,this.appElement.appendChild(this.uiErrorElement),setTimeout(()=>{this.hideUIError()},3e3)}}new x0;export{I0 as $,wa as A,Wt as B,Ve as C,Gc as D,Li as E,P0 as F,Ia as G,tn as H,A0 as I,Ci as J,je as K,is as L,b0 as M,fr as N,lt as O,Vn as P,Ri as Q,ts as R,F0 as S,E0 as T,Nt as U,L as V,T0 as W,pt as X,Kg as Y,Ta as Z,C0 as _,Se as a,bi as a0,wt as a1,Rc as a2,Hc as a3,R0 as a4,Xg as a5,zs as a6,Gs as a7,js as a8,Tt as a9,Zs as aa,Ks as ab,ns as ac,Ke as ad,Nn as ae,or as af,sn as ag,En as ah,xn as b,S0 as c,w0 as d,M0 as e,U0 as f,L0 as g,yn as h,dt as i,N0 as j,D0 as k,Ge as l,Rl as m,dv as n,O0 as o,Gg as p,jn as q,nh as r,ao as s,Dt as t,yt as u,ra as v,aa as w,Kt as x,Zg as y,Dn as z};
