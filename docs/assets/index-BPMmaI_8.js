...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:In,depthTest:!1,depthWrite:!1})}function Xo(){return new $n({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:la(),fragmentShader:`
		...
		`,blending:In,depthTest:!1,depthWrite:!1})}function qo(){return new $n({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:la(),fragmentShader:`
	...
	`}function Df(s){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===zr||l===Gr,d=l===_i||l===xi;if(c||d)if(o.isRenderTargetTexture&&o.needsPMREMUpdate===!0){o.needsPMREMUpdate=!1;let h=e.get(o);return t===null&&(t=new Wo(s)),h=c?t.fromEquirectangular(o,h):t.fromCubemap(o,h),e.set(o,h),h.texture}else{if(e.has(o))return e.get(o).texture;{const h=o.image;if(c&&h&&h.height>0||d&&h&&i(h)){t===null&&(t=new Wo(s));const u=c?t.fromEquirectangular(o):t.fromCubemap(o);return e.set(o,u),o.addEventListener("dispose",r),u.texture}else return null}}}return o}function i(o){let l=0;const c=6;for(let d=0;d<c;d++)o[d]!==void 0&&l++;return l===c}function r(o){const l=o.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function Uf(s){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=s.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const i=t(n);return i===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function Of(s,e,t,n){const i={},r=new WeakMap;function a(h){const u=h.target;u.index!==null&&e.remove(u.index);for(const v in u.attributes)e.remove(u.attributes[v]);for(const v in u.morphAttributes){const g=u.morphAttributes[v];for(let f=0,p=g.length;f<p;f++)e.remove(g[f])}u.removeEventListener("dispose",a),delete i[u.id];const m=r.get(u);m&&(e.remove(m),r.delete(u)),n.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function o(h,u){return i[u.id]===!0||(u.addEventListener("dispose",a),i[u.id]=!0,t.memory.geometries++),u}function l(h){const u=h.attributes;for(const v in u)e.update(u[v],s.ARRAY_BUFFER);const m=h.morphAttributes;for(const v in m){const g=m[v];for(let f=0,p=g.length;f<p;f++)e.update(g[f],s.ARRAY_BUFFER)}}function c(h){const u=[],m=h.index,v=h.attributes.position;let g=0;if(m!==null){const S=m.array;g=m.version;for(let x=0,T=S.length;x<T;x+=3){const L=S[x+0],A=S[x+1],C=S[x+2];u.push(L,A,A,C,C,L)}}else if(v!==void 0){const S=v.array;g=v.version;for(let x=0,T=S.length/3-1;x<T;x+=3){const L=x+0,A=x+1,C=x+2;u.push(L,A,A,C,C,L)}}else return;const f=new(ac(u)?uc:hc)(u,1);f.version=g;const p=r.get(h);p&&e.remove(p),r.set(h,f)}function d(h){const u=r.get(h);if(u){const m=h.index;m!==null&&u.version<m.version&&c(h)}else c(h);return r.get(h)}return{get:o,update:l,getWireframeAttribute:d}}function Ff(s,e,t,n){const i=n.isWebGL2;let r;function a(m){r=m}let o,l;function c(m){o=m.type,l=m.bytesPerElement}function d(m,v){s.drawElements(r,v,o,m*l),t.update(v,r,1)}function h(m,v,g){if(g===0)return;let f,p;if(i)f=s,p="drawElementsInstanced";else if(f=e.get("ANGLE_instanced_arrays"),p="drawElementsInstancedANGLE",f===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}f[p](r,v,o,m*l,g),t.update(v,r,g)}function u(m,v,g){if(g===0)return;const f=e.get("WEBGL_multi_draw");if(f===null)for(let p=0;p<g;p++)this.render(m[p]/l,v[p]);else{f.multiDrawElementsWEBGL(r,v,0,o,m,0,g);let p=0;for(let S=0;S<g;S++)p+=v[S];t.update(p,r,1)}}this.setMode=a,this.setIndex=c,this.render=d,this.renderInstances=h,this.renderMultiDraw=u}function kf(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case s.TRIANGLES:t.triangles+=o*(r/3);break;case s.LINES:t.lines+=o*(r/2);break;case s.LINE_STRIP:t.lines+=o*(r-1);break;case s.LINE_LOOP:t.lines+=o*r;break;case s.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function Bf(s,e){return s[0]-e[0]}function Hf(s,e){return Math.abs(e[1])-Math.abs(s[1])}function Vf(s,e,t){const n={},i=new Float32Array(8),r=new WeakMap,a=new Ze,o=[];for(let c=0;c<8;c++)o[c]=[c,0];function l(c,d,h){const u=c.morphTargetInfluences;if(e.isWebGL2===!0){const m=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,v=m!==void 0?m.length:0;let g=r.get(d);if(g===void 0||g.count!==v){let P=function(){W.dispose(),r.delete(d),d.removeEventListener("dispose",P)};g!==void 0&&g.texture.dispose();const S=d.morphAttributes.position!==void 0,x=d.morphAttributes.normal!==void 0,T=d.morphAttributes.color!==void 0,L=d.morphAttributes.position||[],A=d.morphAttributes.normal||[],C=d.morphAttributes.color||[];let z=0;S===!0&&(z=1),x===!0&&(z=2),T===!0&&(z=3);let E=d.attributes.position.count*z,w=1;E>e.maxTextureSize&&(w=Math.ceil(E/e.maxTextureSize),E=e.maxTextureSize);const H=new Float32Array(E*w*4*v),W=new cc(H,E,w,v);W.type=mn,W.needsUpdate=!0;const ne=z*4;for(let D=0;D<v;D++){const G=L[D],q=A[D],X=C[D],Y=E*w*4*D;for(let Z=0;Z<G.count;Z++){const ee=Z*ne;S===!0&&(a.fromBufferAttribute(G,Z),H[Y+ee+0]=a.x,H[Y+ee+1]=a.y,H[Y+ee+2]=a.z,H[Y+ee+3]=0),x===!0&&(a.fromBufferAttribute(q,Z),H[Y+ee+4]=a.x,H[Y+ee+5]=a.y,H[Y+ee+6]=a.z,H[Y+ee+7]=0),T===!0&&(a.fromBufferAttribute(X,Z),H[Y+ee+8]=a.x,H[Y+ee+9]=a.y,H[Y+ee+10]=a.z,H[Y+ee+11]=X.itemSize===4?a.w:1)}}g={count:v,texture:W,size:new De(E,w)},r.set(d,g),d.addEventListener("dispose",P)}let f=0;for(let S=0;S<u.length;S++)f+=u[S];const p=d.morphTargetsRelative?1:1-f;h.getUniforms().setValue(s,"morphTargetBaseInfluence",p),h.getUniforms().setValue(s,"morphTargetInfluences",u),h.getUniforms().setValue(s,"morphTargetsTexture",g.texture,t),h.getUniforms().setValue(s,"morphTargetsTextureSize",g.size)}else{const m=u===void 0?0:u.length;let v=n[d.id];if(v===void 0||v.length!==m){v=[];for(let x=0;x<m;x++)v[x]=[x,0];n[d.id]=v}for(let x=0;x<m;x++){const T=v[x];T[0]=x,T[1]=u[x]}v.sort(Hf);for(let x=0;x<8;x++)x<m&&v[x][1]?(o[x][0]=v[x][0],o[x][1]=v[x][1]):(o[x][0]=Number.MAX_SAFE_INTEGER,o[x][1]=0);o.sort(Bf);const g=d.morphAttributes.position,f=d.morphAttributes.normal;let p=0;for(let x=0;x<8;x++){const T=o[x],L=T[0],A=T[1];L!==Number.MAX_SAFE_INTEGER&&A?(g&&d.getAttribute("morphTarget"+x)!==g[L]&&d.setAttribute("morphTarget"+x,g[L]),f&&d.getAttribute("morphNormal"+x)!==f[L]&&d.setAttribute("morphNormal"+x,f[L]),i[x]=A,p+=A):(g&&d.hasAttribute("morphTarget"+x)===!0&&d.deleteAttribute("morphTarget"+x),f&&d.hasAttribute("morphNormal"+x)===!0&&d.deleteAttribute("morphNormal"+x),i[x]=0)}const S=d.morphTargetsRelative?1:1-p;h.getUniforms().setValue(s,"morphTargetBaseInfluence",S),h.getUniforms().setValue(s,"morphTargetInfluences",i)}}return{update:l}}function zf(s,e,t,n){let i=new WeakMap;function r(l){const c=n.render.frame,d=l.geometry,h=e.get(l,d);if(i.get(h)!==c&&(e.update(h),i.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),i.get(l)!==c&&(t.update(l.instanceMatrix,s.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,s.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const u=l.skeleton;i.get(u)!==c&&(u.update(),i.set(u,c))}return h}function a(){i=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:a}}class _c extends Tt{constructor(e,t,n,i,r,a,o,l,c,d){if(d=d!==void 0?d:Yn,d!==Yn&&d!==yi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&d===Yn&&(n=An),n===void 0&&d===yi&&(n=Wn),super(null,i,r,a,o,l,d,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:yt,this.minFilter=l!==void 0?l:yt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const xc=new Tt,yc=new _c(1,1);yc.compareFunction=rc;const bc=new cc,Ec=new wh,Sc=new mc,$o=[],jo=[],Ko=new Float32Array(16),Zo=new Float32Array(9),Jo=new Float32Array(4);function Ai(s,e,t){const n=s[0];if(n<=0||n>0)return s;const i=e*t;let r=$o[i];if(r===void 0&&(r=new Float32Array(i),$o[i]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,s[a].toArray(r,o)}return r}function mt(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function gt(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function Ws(s,e){let t=jo[e];t===void 0&&(t=new Int32Array(e),jo[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function Gf(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function Wf(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(mt(t,e))return;s.uniform2fv(this.addr,e),gt(t,e)}}function Yf(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(mt(t,e))return;s.uniform3fv(this.addr,e),gt(t,e)}}function Xf(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(mt(t,e))return;s.uniform4fv(this.addr,e),gt(t,e)}}function qf(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(mt(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),gt(t,e)}else{if(mt(t,n))return;Jo.set(n),s.uniformMatrix2fv(this.addr,!1,Jo),gt(t,n)}}function $f(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(mt(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),gt(t,e)}else{if(mt(t,n))return;Zo.set(n),s.uniformMatrix3fv(this.addr,!1,Zo),gt(t,n)}}function jf(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(mt(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),gt(t,e)}else{if(mt(t,n))return;Ko.set(n),s.uniformMatrix4fv(this.addr,!1,Ko),gt(t,n)}}function Kf(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function Zf(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(mt(t,e))return;s.uniform2iv(this.addr,e),gt(t,e)}}function Jf(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(mt(t,e))return;s.uniform3iv(this.addr,e),gt(t,e)}}function Qf(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(mt(t,e))return;s.uniform4iv(this.addr,e),gt(t,e)}}function em(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function tm(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(mt(t,e))return;s.uniform2uiv(this.addr,e),gt(t,e)}}function nm(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(mt(t,e))return;s.uniform3uiv(this.addr,e),gt(t,e)}}function im(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(mt(t,e))return;s.uniform4uiv(this.addr,e),gt(t,e)}}function sm(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);const r=this.type===s.SAMPLER_2D_SHADOW?yc:xc;t.setTexture2D(e||r,i)}function rm(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||Ec,i)}function am(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||Sc,i)}function om(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||bc,i)}function lm(s){switch(s){case 5126:return Gf;case 35664:return Wf;case 35665:return Yf;case 35666:return Xf;case 35674:return qf;case 35675:return $f;case 35676:return jf;case 5124:case 35670:return Kf;case 35667:case 35671:return Zf;case 35668:case 35672:return Jf;case 35669:case 35673:return Qf;case 5125:return em;case 36294:return tm;case 36295:return nm;case 36296:return im;case 35678:case 36198:case 36298:case 36306:case 35682:return sm;case 35679:case 36299:case 36307:return rm;case 35680:case 36300:case 36308:case 36293:return am;case 36289:case 36303:case 36311:case 36292:return om}}function cm(s,e){s.uniform1fv(this.addr,e)}function dm(s,e){const t=Ai(e,this.size,2);s.uniform2fv(this.addr,t)}function hm(s,e){const t=Ai(e,this.size,3);s.uniform3fv(this.addr,t)}function um(s,e){const t=Ai(e,this.size,4);s.uniform4fv(this.addr,t)}function pm(s,e){const t=Ai(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function fm(s,e){const t=Ai(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function mm(s,e){const t=Ai(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function gm(s,e){s.uniform1iv(this.addr,e)}function vm(s,e){s.uniform2iv(this.addr,e)}function _m(s,e){s.uniform3iv(this.addr,e)}function xm(s,e){s.uniform4iv(this.addr,e)}function ym(s,e){s.uniform1uiv(this.addr,e)}function bm(s,e){s.uniform2uiv(this.addr,e)}function Em(s,e){s.uniform3uiv(this.addr,e)}function Sm(s,e){s.uniform4uiv(this.addr,e)}function Mm(s,e,t){const n=this.cache,i=e.length,r=Ws(t,i);mt(n,r)||(s.uniform1iv(this.addr,r),gt(n,r));for(let a=0;a!==i;++a)t.setTexture2D(e[a]||xc,r[a])}function wm(s,e,t){const n=this.cache,i=e.length,r=Ws(t,i);mt(n,r)||(s.uniform1iv(this.addr,r),gt(n,r));for(let a=0;a!==i;++a)t.setTexture3D(e[a]||Ec,r[a])}function Tm(s,e,t){const n=this.cache,i=e.length,r=Ws(t,i);mt(n,r)||(s.uniform1iv(this.addr,r),gt(n,r));for(let a=0;a!==i;++a)t.setTextureCube(e[a]||Sc,r[a])}function Am(s,e,t){const n=this.cache,i=e.length,r=Ws(t,i);mt(n,r)||(s.uniform1iv(this.addr,r),gt(n,r));for(let a=0;a!==i;++a)t.setTexture2DArray(e[a]||bc,r[a])}function Cm(s){switch(s){case 5126:return cm;case 35664:return dm;case 35665:return hm;case 35666:return um;case 35674:return pm;case 35675:return fm;case 35676:return mm;case 5124:case 35670:return gm;case 35667:case 35671:return vm;case 35668:case 35672:return _m;case 35669:case 35673:return xm;case 5125:return ym;case 36294:return bm;case 36295:return Em;case 36296:return Sm;case 35678:case 36198:case 36298:case 36306:case 35682:return Mm;case 35679:case 36299:case 36307:return wm;case 35680:case 36300:case 36308:case 36293:return Tm;case 36289:case 36303:case 36311:case 36292:return Am}}class Im{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=lm(t.type)}}class Lm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Cm(t.type)}}class Rm{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let r=0,a=i.length;r!==a;++r){const o=i[r];o.setValue(e,t[o.id],n)}}}const Cr=/(\w+)(\])?(\[|\.)?/g;function Qo(s,e){s.seq.push(e),s.map[e.id]=e}function Pm(s,e,t){const n=s.name,i=n.length;for(Cr.lastIndex=0;;){const r=Cr.exec(n),a=Cr.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===i){Qo(t,c===void 0?new Im(o,s,e):new Lm(o,s,e));break}else{let h=t.map[o];h===void 0&&(h=new Rm(o),Qo(t,h)),t=h}}}class Is{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const r=e.getActiveUniform(t,i),a=e.getUniformLocation(t,r.name);Pm(r,a,this)}}setValue(e,t,n,i){const r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,r=e.length;i!==r;++i){const a=e[i];a.id in t&&n.push(a)}return n}}function el(s,e,t){const n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}const Nm=37297;let Dm=0;function Um(s,e){const t=s.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=i;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}function Om(s){const e=Ke.getPrimaries(Ke.workingColorSpace),t=Ke.getPrimaries(s);let n;switch(e===t?n="":e===Us&&t===Ds?n="LinearDisplayP3ToLinearSRGB":e===Ds&&t===Us&&(n="LinearSRGBToLinearDisplayP3"),s){case xn:case zs:return[n,"LinearTransferOETF"];case ht:case ia:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",s),[n,"LinearTransferOETF"]}}function tl(s,e,t){const n=s.getShaderParameter(e,s.COMPILE_STATUS),i=s.getShaderInfoLog(e).trim();if(n&&i==="")return"";const r=/ERROR: 0:(\d+)/.exec(i);if(r){const a=parseInt(r[1]);return t.toUpperCase()+`

`+i+`

`+Um(s.getShaderSource(e),a)}else return i}function Fm(s,e){const t=Om(e);return`vec4 ${s}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function km(s,e){let t;switch(e){case Dd:t="Linear";break;case Ud:t="Reinhard";break;case Od:t="OptimizedCineon";break;case $l:t="ACESFilmic";break;case kd:t="AgX";break;case Fd:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function Bm(s){return[s.extensionDerivatives||s.envMapCubeUVHeight||s.bumpMap||s.normalMapTangentSpace||s.clearcoatNormalMap||s.flatShading||s.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(s.extensionFragDepth||s.logarithmicDepthBuffer)&&s.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",s.extensionDrawBuffers&&s.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(s.extensionShaderTextureLOD||s.envMap||s.transmission)&&s.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(fi).join(`
`)}function Hm(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(fi).join(`
`)}function Vm(s){const e=[];for(const t in s){const n=s[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function zm(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),a=r.name;let o=1;r.type===s.FLOAT_MAT2&&(o=2),r.type===s.FLOAT_MAT3&&(o=3),r.type===s.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:s.getAttribLocation(e,a),locationSize:o}}return t}function fi(s){return s!==""}function nl(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function il(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Gm=/^[ \t]*#include +<([\w\d./]+)>/gm;function jr(s){return s.replace(Gm,Ym)}const Wm=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Ym(s,e){let t=Ne[e];if(t===void 0){const n=Wm.get(e);if(n!==void 0)t=Ne[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return jr(t)}const Xm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function sl(s){return s.replace(Xm,qm)}function qm(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function rl(s){let e="precision "+s.precision+` float;
precision `+s.precision+" int;";return s.precision==="highp"?e+=`
#define HIGH_PRECISION`:s.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:s.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function $m(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Xl?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===ld?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===fn&&(e="SHADOWMAP_TYPE_VSM"),e}function jm(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case _i:case xi:e="ENVMAP_TYPE_CUBE";break;case Vs:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Km(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case xi:e="ENVMAP_MODE_REFRACTION";break}return e}function Zm(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case ql:e="ENVMAP_BLENDING_MULTIPLY";break;case Pd:e="ENVMAP_BLENDING_MIX";break;case Nd:e="ENVMAP_BLENDING_ADD";break}return e}function Jm(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Qm(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=$m(t),c=jm(t),d=Km(t),h=Zm(t),u=Jm(t),m=t.isWebGL2?"":Bm(t),v=Hm(t),g=Vm(r),f=i.createProgram();let p,S,x=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
    ...
    `,document.head.appendChild(e)}setTitle(e){const t=this.element.querySelector(".title-text");t&&(t.textContent=e)}getElement(){return this.element}remove(){this.element.remove()}}class Mv{constructor(e){_(this,"element");_(this,"museums");this.museums=e,this.element=document.createElement("div"),this.element.className="museum-list",this.render(),this.applyStyles()}render(){const e=this.museums.filter(n=>n.id==="wangding"),t=this.museums.filter(n=>n.id!=="wangding");this.element.innerHTML=`
    ...
    `,this.element.querySelectorAll(".museum-card-active").forEach(n=>{n.addEventListener("click",()=>{const i=n.getAttribute("data-museum-id");i&&Br(i)})})}applyStyles(){const e=document.createElement("style");e.textContent=`
      .museum-list {
        width: 100%;
        height: 100%;
        overflow-y: auto;
...
<svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M12 4v16M12 4l6 6M12 4l-6 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    `,document.head.appendChild(e)}getElement(){return this.element}remove(){this.element.remove()}}class Gv{constructor(){_(this,"element");this.element=document.createElement("div"),this.element.className="loading-overlay",this.render(),this.applyStyles()}render(){this.element.innerHTML=`
    ...
    `,document.head.appendChild(e)}getElement(){return this.element}remove(){this.element.remove()}}const ba="vrplayer_config_draft_v1";function Ol(){try{const s=localStorage.getItem(ba);return s?JSON.parse(s):null}catch(s){return console.warn("加载草稿失败",s),null}}function Xv(s){try{const e=JSON.stringify(s);return localStorage.setItem(ba,e),{ok:!0}}catch(e){return console.warn("保存草稿失败",e),{ok:!1,reason:e instanceof Error?e.message:"unknown"}}}function qv(){try{localStorage.removeItem(ba)}catch(s){console.warn("清空草稿失败",s)}}const Uc="vr_last_pick_v1";let Ea=null;function $v(){try{const s=localStorage.getItem(Uc);if(s){const e=JSON.parse(s);typeof e.yaw=="number"&&typeof e.pitch=="number"&&typeof e.ts=="number"&&(Ea=e)}}catch{}}$v();function jv(s){Ea=s;try{localStorage.setItem(Uc,JSON.stringify(s))}catch{}}function Fl(){return Ea}const kl="vrplayer_config_draft_ignore_session";class Kv{constructor(e,t){_(this,"element");_(this,"config");_(this,"initialConfig");_(this,"editingTarget",{type:"global"});_(this,"simpleMode",!0);_(this,"validationErrors",[]);_(this,"validationDebounceTimer",null);_(this,"draftSaveTimer",null);_(this,"draftLoaded",!1);_(this,"draftIgnoreSession",!1);_(this,"draftBannerMessage",null);_(this,"onConfigChange");this.config=JSON.parse(JSON.stringify(e)),this.initialConfig=JSON.parse(JSON.stringify(e)),this.onConfigChange=t;try{this.draftIgnoreSession=sessionStorage.getItem(kl)==="1"}catch(n){console.warn("读取草稿忽略状态失败",n),this.draftIgnoreSession=!1}this.tryRestoreDraft(),this.element=document.createElement("div"),this.element.className="config-studio",this.render(),this.applyStyles(),this.renderDraftBanner(),this.validateConfig()}tryRestoreDraft(){if(this.draftIgnoreSession)return;const e=Ol();e&&(this.config=JSON.parse(JSON.stringify(e)),this.draftLoaded=!0,this.draftBannerMessage="检测到未导出的草稿，已自动恢复。",this.onConfigChange&&this.onConfigChange(this.config))}renderDraftBanner(){const e=this.element.querySelector("#draft-banner");if(!e)return;if(!this.draftLoaded||this.draftIgnoreSession){e.innerHTML="",e.style.display="none";return}const t=this.draftBannerMessage||"检测到未导出的草稿，已自动恢复。";e.innerHTML=`
    ...
    `,document.head.appendChild(e)}}function Zv(){const s=document;return document.fullscreenElement||s.webkitFullscreenElement||null}function Qr(){return!!Zv()}async function Bl(s){const e=s;if(e.requestFullscreen){await e.requestFullscreen();return}if(e.webkitRequestFullscreen){await e.webkitRequestFullscreen();return}throw new Error("Fullscreen API not supported")}async function Jv(){const s=document;if(document.exitFullscreen){await document.exitFullscreen();return}if(s.webkitExitFullscreen){await s.webkitExitFullscreen();return}}async function Qv(s){if(!s){const e=document.body;return Bl(e)}return Bl(s)}async function e_(){try{await Jv(),Oc()}catch(s){console.debug("[fullscreen] exitFullscreenBestEffort failed:",s)}}function Oc(){var s,e;try{(e=(s=screen.orientation)==null?void 0:s.unlock)==null||e.call(s)}catch{}}function t_(){return`
...
<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M15 15l3 3" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    `,this.element.appendChild(e),this.element.appendChild(this.container),this.element.appendChild(this.webglErrorEl),this.element.appendChild(this.modelErrorEl)}updateStatusText(){var a,o,l;if(!this.statusEl)return;const e=this.graph.nodes.length,t=this.graph.edges.length,n=((a=this.container)==null?void 0:a.clientWidth)||0,i=((o=this.container)==null?void 0:o.clientHeight)||0,r=this.modelLoaded?"loaded":(l=this.museum.dollhouse)!=null&&l.modelUrl?"loading":"none";e===0?(this.statusEl.textContent=`model: ${r}, No nodes (check museum.scenes)`,this.statusEl.style.color="rgba(255,200,100,0.9)"):(this.statusEl.textContent=`model: ${r}, nodes: ${e}, edges: ${t}, size: ${n}x${i}`,this.statusEl.style.color="rgba(255,255,255,0.65)")}async init3D(){var e;try{this.scene=new ca,this.scene.background=null;const t=this.container.clientWidth>0?this.container.clientWidth/this.container.clientHeight:window.innerWidth/window.innerHeight;this.camera=new wt(60,t,.1,1e3),this.camera.position.set(0,12,18),this.camera.lookAt(0,0,0);try{this.renderer=new Ys({antialias:!0,alpha:!0}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.container.appendChild(this.renderer.domElement)}catch{this.webglErrorEl&&(this.webglErrorEl.style.display="block");return}try{const{OrbitControls:r}=await zi(async()=>{const{OrbitControls:a}=await import("./OrbitControls-CwYt3eRS.js");return{OrbitControls:a}},[],import.meta.url);this.controls=new r(this.camera,this.renderer.domElement),this.controls.enableDamping=!0,this.controls.dampingFactor=.05,this.controls.minDistance=3,this.controls.maxDistance=50,this.controls.maxPolarAngle=Math.PI/2.2,this.controls.minPolarAngle=Math.PI/6,this.controls.target.set(0,0,0)}catch{}const n=new Ic(16777215,.6);this.scene.add(n);const i=new Cc(16777215,.4);i.position.set(5,10,5),this.scene.add(i),this.modelGroup=new mi,this.scene.add(this.modelGroup),(e=this.museum.dollhouse)!=null&&e.modelUrl?this.loadModel():this.generateGraph(),this.setupResizeObserver(),this.updateStatusText()}catch{this.webglErrorEl&&(this.webglErrorEl.style.display="block")}}async loadModel(){var t;if(!((t=this.museum.dollhouse)!=null&&t.modelUrl)||!this.scene||!this.modelGroup)return;const e=yn(this.museum.dollhouse.modelUrl,rn.DOLLHOUSE);if(e)try{const{GLTFLoader:n}=await zi(async()=>{const{GLTFLoader:c}=await import("./GLTFLoader-BaTx5vyZ.js");return{GLTFLoader:c}},[],import.meta.url),r=await new n().loadAsync(e);for(;this.modelGroup.children.length>0;){const c=this.modelGroup.children[0];this.modelGroup.remove(c),(c instanceof ut||c instanceof mi)&&c.traverse(d=>{var h,u;d instanceof ut&&((h=d.geometry)==null||h.dispose(),Array.isArray(d.material)?d.material.forEach(m=>m.dispose()):(u=d.material)==null||u.dispose())})}const a=r.scene,o=this.museum.dollhouse.scale??1,l=this.museum.dollhouse.offset??{x:0,y:0,z:0};a.scale.set(o,o,o),a.position.set(l.x,l.y,l.z),this.modelGroup.add(a),this.modelLoaded=!0,this.generateGraph(),this.fitModelToView(),this.updateStatusText(),this.modelErrorEl&&(this.modelErrorEl.style.display="none")}catch{this.modelLoaded=!1,this.updateStatusText(),this.modelErrorEl&&(this.modelErrorEl.style.display="block"),this.generateGraph()}}fitModelToView(){if(!this.modelGroup||!this.scene||!this.camera||!this.controls)return;const e=new sn().setFromObject(this.modelGroup),t=e.getCenter(new R),n=e.getSize(new R),i=Math.max(n.x,n.y,n.z),r=i*2;this.camera.position.set(t.x,t.y+n.y*.5,t.z+r),this.camera.lookAt(t),this.camera.updateProjectionMatrix(),this.controls.target.copy(t),this.controls.update(),this.controls.minDistance=i*.5,this.controls.maxDistance=i*5}setupResizeObserver(){if(!this.container||typeof ResizeObserver>"u"){window.addEventListener("resize",()=>this.handleResize());return}this.resizeObserver=new ResizeObserver(()=>{this.handleResize()}),this.resizeObserver.observe(this.container)}handleResize(){if(!this.renderer||!this.camera||!this.container)return;const e=this.container.clientWidth,t=this.container.clientHeight;e===0||t===0||(this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t,!1),this.updateStatusText())}generateGraph(){var l,c;if(!this.scene)return;this.sceneNodes.forEach(d=>{this.scene.remove(d),d.geometry.dispose(),Array.isArray(d.material)?d.material.forEach(h=>h.dispose()):d.material.dispose()}),this.sceneNodes.clear(),this.edgeLines.forEach(d=>{this.scene.remove(d),d.geometry.dispose(),Array.isArray(d.material)?d.material.forEach(h=>h.dispose()):d.material.dispose()}),this.edgeLines=[];const e=this.modelLoaded&&this.modelGroup&&this.modelGroup.children.length>0,t=Wc(this.graph.nodes),n=((l=this.museum.map)==null?void 0:l.width)||1e3,i=((c=this.museum.map)==null?void 0:c.height)||600;let r={};if(t)r=Gc(this.graph.nodes,this.graph.edges,{width:n,height:i,iterations:300,padding:40});else for(const d of this.graph.nodes)d.mapPoint&&(r[d.id]={x:d.mapPoint.x,y:d.mapPoint.y});const o=(d=>{const h=Object.entries(d);if(h.length===0)return{};let u=1/0,m=-1/0,v=1/0,g=-1/0;for(const[,C]of h)u=Math.min(u,C.x),m=Math.max(m,C.x),v=Math.min(v,C.y),g=Math.max(g,C.y);const f=m-u||1,p=g-v||1,S=20/f,x=20/p,T=(u+m)/2,L=(v+g)/2,A={};for(const[C,z]of h){const E=N_(this.graph,C),w=(Math.random()-.5)*.5;A[C]={x:(z.x-T)*S,y:E*1.5+w,z:(z.y-L)*x}}return A})(r);if(!e)for(const d of this.graph.edges){const h=o[d.from],u=o[d.to];if(!h||!u)continue;const m=new Ut().setFromPoints([new R(h.x,h.y,h.z),new R(u.x,u.y,u.z)]),v=new da({color:16777215,opacity:.3,transparent:!0}),g=new ha(m,v);this.scene.add(g),this.edgeLines.push(g)}for(const d of this.graph.nodes){const h=o[d.id];if(!h)continue;const u=d.id===this.currentSceneId,m=new Xs(u?.8:.6,16,16),v=new fa({color:u?4886754:8947848,opacity:u?.9:.7,transparent:!0,metalness:.1,roughness:.7}),g=new ut(m,v);if(e&&this.modelGroup){const f=new sn().setFromObject(this.modelGroup),p=f.getCenter(new R),S=f.getSize(new R);g.position.set(p.x+h.x*.1,p.y+S.y*.5+h.y*.1+1,p.z+h.z*.1)}else g.position.set(h.x,h.y,h.z);g.userData={sceneId:d.id,sceneName:d.name},u&&(g.userData.isCurrent=!0,g.scale.set(1.2,1.2,1.2)),this.scene.add(g),this.sceneNodes.set(d.id,g)}}handleClick(e){if(!this.renderer||!this.camera||this.sceneNodes.size===0)return;const t=this.renderer.domElement.getBoundingClientRect(),n=(e.clientX-t.left)/t.width*2-1,i=-((e.clientY-t.top)/t.height)*2+1,r=new Yi;r.setFromCamera(new De(n,i),this.camera);const a=r.intersectObjects(Array.from(this.sceneNodes.values()));if(a.length>0){const l=a[0].object.userData.sceneId;l&&this.onNodeClick&&this.onNodeClick(this.museum.id,l)}}handleMouseMove(e){if(!this.renderer||!this.camera||this.sceneNodes.size===0)return;const t=this.renderer.domElement.getBoundingClientRect(),n=(e.clientX-t.left)/t.width*2-1,i=-((e.clientY-t.top)/t.height)*2+1,r=new Yi;r.setFromCamera(new De(n,i),this.camera);const a=r.intersectObjects(Array.from(this.sceneNodes.values()));if(this.sceneNodes.forEach(o=>{const l=o.material;o.userData.isCurrent||(l.opacity=.7)}),a.length>0){const o=a[0].object,l=o.material,c=o.userData.sceneId;o.userData.isCurrent||(l.opacity=.9),this.hoveredSceneId=c,this.renderer.domElement.style.cursor="pointer"}else this.hoveredSceneId=null,this.renderer.domElement.style.cursor="default"}bindEvents(){if(!this.renderer)return;const e=this.renderer.domElement;e.addEventListener("click",n=>this.handleClick(n)),e.addEventListener("mousemove",n=>this.handleMouseMove(n));const t=n=>{n.key==="Escape"&&this.close()};document.addEventListener("keydown",t),this.element.addEventListener("vr:cleanup",()=>{document.removeEventListener("keydown",t)})}updateContext(e){var t,n;if(this.museum=e.museum,this.graph=e.graph,this.currentSceneId=e.currentSceneId,this.scene){const i=(t=e.museum.dollhouse)==null?void 0:t.modelUrl,r=(n=this.museum.dollhouse)==null?void 0:n.modelUrl;if(i!==r){if(this.modelGroup)for(;this.modelGroup.children.length>0;){const a=this.modelGroup.children[0];this.modelGroup.remove(a)}this.modelLoaded=!1,i?this.loadModel():this.generateGraph()}else this.generateGraph();this.updateStatusText()}}open(){this.element.classList.add("is-visible"),requestAnimationFrame(()=>{requestAnimationFrame(()=>{this.handleResize(),!this.animationId&&this.renderer&&this.scene&&this.camera&&this.animate()})})}close(){this.element.classList.remove("is-visible"),this.onClose&&this.onClose()}getElement(){return this.element}remove(){this.animationId!==null&&(cancelAnimationFrame(this.animationId),this.animationId=null),this.resizeObserver&&(this.resizeObserver.disconnect(),this.resizeObserver=null),this.scene&&(this.sceneNodes.forEach(e=>{this.scene.remove(e),e.geometry.dispose(),Array.isArray(e.material)?e.material.forEach(t=>t.dispose()):e.material.dispose()}),this.sceneNodes.clear(),this.edgeLines.forEach(e=>{this.scene.remove(e),e.geometry.dispose(),Array.isArray(e.material)?e.material.forEach(t=>t.dispose()):e.material.dispose()}),this.edgeLines=[],this.modelGroup&&(this.modelGroup.traverse(e=>{var t,n;e instanceof ut&&((t=e.geometry)==null||t.dispose(),Array.isArray(e.material)?e.material.forEach(i=>i.dispose()):(n=e.material)==null||n.dispose())}),this.scene.remove(this.modelGroup),this.modelGroup=null)),this.renderer&&(this.renderer.dispose(),this.renderer.domElement.parentNode&&this.renderer.domElement.parentNode.removeChild(this.renderer.domElement),this.renderer=null),this.controls&&(this.controls.dispose(),this.controls=null),window.removeEventListener("resize",()=>this.handleResize()),this.scene=null,this.camera=null,this.element.remove()}}function U_(s,e,t){const n=s.getBoundingClientRect(),i=e-n.left,r=t-n.top,a=document.createElement("div");a.className="vr-pick-marker",a.style.position="absolute",a.style.left="0",a.style.top="0",a.style.transform=`translate3d(${i}px, ${r}px, 0)`,a.style.pointerEvents="none",a.style.zIndex="1000",s.style.position="relative",s.appendChild(a),window.requestAnimationFrame(()=>{a.classList.add("show")}),window.setTimeout(()=>{a.classList.remove("show"),window.setTimeout(()=>{a.parentNode&&a.parentNode.removeChild(a)},200)},1500)}const O_=150,F_=150,k_=400;function B_(){return{fadeMs:O_,restoreMs:F_,restoreDelayMs:k_}}function H_(){Je.on("user-interacting",()=>{}),Je.on("user-idle",()=>{}),Je.on("ui-engaged",()=>{})}let qt=null;function V_(){const s=B_();Je.on("user-interacting",()=>{qt!==null&&(clearTimeout(qt),qt=null),document.documentElement.classList.add("vr-ui-interacting"),document.documentElement.classList.remove("vr-ui-restoring")}),Je.on("user-idle",()=>{qt!==null&&(clearTimeout(qt),qt=null),document.documentElement.classList.remove("vr-ui-interacting"),qt=window.setTimeout(()=>{document.documentElement.classList.remove("vr-ui-restoring"),qt=null},s.restoreDelayMs)}),Je.on("ui-engaged",()=>{qt!==null&&(clearTimeout(qt),qt=null),document.documentElement.classList.remove("vr-ui-interacting"),document.documentElement.classList.remove("vr-ui-restoring")})}function z_(){const s={};try{const e=new URLSearchParams(window.location.search),t=e.get("museum"),n=e.get("scene");t&&(s.museumId=t),n&&(s.currentSceneId=n)}catch{}try{const e=document.querySelector(".vr-groundnav");if(e){s.groundNavDots={};const t=e.querySelector(".vr-groundnav__dot.is-aimed");t&&(s.groundNavDots.aimedSceneId=t.getAttribute("data-scene-id")||void 0);const n=e.querySelector(".vr-groundnav__dot.is-autonav");if(n){s.groundNavDots.isAutoNavActive=!0,s.groundNavDots.autoNavTargetSceneId=n.getAttribute("data-scene-id")||void 0;const i=n.querySelector(".vr-groundnav__progress");s.groundNavDots.hasProgressElement=!!i}}}catch{}try{const e=document.querySelector(".vr-previewcard");if(e){s.scenePreviewCard={},s.scenePreviewCard.isVisible=e.classList.contains("is-visible");const t=e.querySelector(".vr-previewcard__hint");t&&(s.scenePreviewCard.hintVisible=t.classList.contains("is-visible"),s.scenePreviewCard.hintEmphasizing=t.classList.contains("is-emphasizing"))}}catch{}try{const e=document.querySelector(".vr-scenestrip");e&&(s.sceneStrip={},s.sceneStrip.userScrolling=e.classList.contains("is-user-scrolling"))}catch{}try{const e=document.documentElement,t=Array.from(e.classList).filter(n=>n==="vr-ui-interacting"||n==="vr-ui-restoring");t.length>0&&(s.yieldClassManager={classes:t})}catch{}return s}function G_(s){try{window.dispatchEvent(new CustomEvent("vr:close-panels"))}catch{}try{s?(s.emitInteracting(),setTimeout(()=>{try{document.documentElement.classList.remove("vr-ui-interacting","vr-ui-restoring")}catch{}},100)):document.documentElement.classList.remove("vr-ui-interacting","vr-ui-restoring")}catch{}}class W_{constructor(e){_(this,"element");_(this,"overlay");_(this,"getCurrentYaw");_(this,"sceneId");_(this,"onClose");_(this,"currentYawEl",null);_(this,"resultEl",null);_(this,"updateTimer",null);_(this,"northYawValue",null);this.getCurrentYaw=e.getCurrentYaw,this.sceneId=e.sceneId,this.onClose=e.onClose,this.overlay=document.createElement("div"),this.overlay.className="vr-north-calibration-overlay",this.overlay.style.cssText=`
      position: fixed;
      top: 0;
      left: 0;
      right: 0;
    ...
    `,document.head.appendChild(e)}getElement(){return this.root}remove(){this.destroy()}}function X_(s){try{return JSON.parse(s)}catch{return null}}function Fr(s){return typeof s=="string"?s:""}function q_(s){return s.endsWith("/")?s:s+"/"}function $_(s,e){const t={question:s};return e&&typeof e=="object"&&(t.context={museumId:e.museumId||"",museumName:e.museumName||"",sceneId:e.sceneId||"",sceneTitle:e.sceneTitle||"",url:e.url||""}),t}function j_(s){if(s&&typeof s=="object"&&typeof s.answer=="string"&&s.answer.trim())return{ok:!0,answer:s.answer.trim(),model:Fr(s.model)||void 0};if(s&&typeof s=="object"&&("code"in s||"msg"in s||"data"in s)){const e=typeof s.code=="number"?s.code:void 0,t=Fr(s.msg)||"",n=s.data;if((e===0||e===void 0)&&n&&typeof n=="object"){const i=typeof n.answer=="string"?n.answer.trim():"";if(i)return{ok:!0,answer:i,model:Fr(n.model)||void 0}}if(e===40101||t.toLowerCase()==="unauthorized")return{ok:!1,code:40101,msg:"unauthorized"};if(e!==void 0&&e!==0)return{ok:!1,code:e,msg:t||`error code=${e}`};if(t&&t.toLowerCase()!=="ok")return{ok:!1,code:e,msg:t}}return{ok:!1,msg:"bad response"}}class K_{constructor(e){_(this,"endpoint");_(this,"authToken");_(this,"timeoutMs");if(!(e!=null&&e.endpoint))throw new Error("fcChat endpoint is empty");this.endpoint=q_(e.endpoint),this.authToken=e.authToken||"",this.timeoutMs=typeof e.timeoutMs=="number"&&e.timeoutMs>0?e.timeoutMs:15e3}async ask(e,t){const n=(e||"").trim();if(!n)throw new Error("empty question");const i=new AbortController,r=setTimeout(()=>i.abort(),this.timeoutMs);try{const a={"Content-Type":"application/json"};this.authToken&&(a.Authorization=this.authToken.startsWith("Bearer ")?this.authToken:`Bearer ${this.authToken}`);const o=await fetch(this.endpoint,{method:"POST",headers:a,body:JSON.stringify($_(n,t)),signal:i.signal}),l=await o.text(),c=X_(l);if(!c){const u=l?`bad response: ${l}`:`http ${o.status}`;throw new Error(u)}const d=j_(c);if(d.ok)return{answer:d.answer,model:d.model};if(d.code===40101){const u=new Error("unauthorized (code=40101)");throw u.code=40101,u}const h=d.code?`${d.msg} (code=${d.code})`:d.msg;throw new Error(h||"request failed")}catch(a){throw(a==null?void 0:a.name)==="AbortError"?new Error(`timeout (${this.timeoutMs}ms)`):a}finally{clearTimeout(r)}}}ft&&(window.__vrDump=()=>{const s=z_();return console.debug("[VR State Snapshot]",s),s},window.__vrResetUI=()=>{console.debug("[VR Reset UI] 正在清理所有 UI 状态..."),G_(Je),console.debug("[VR Reset UI] 清理完成")},console.debug("[VR Debug] 调试模式已启用。使用 __vrDump() 查看状态，使用 __vrResetUI() 复位 UI"));nd();H_();V_();class Z_{constructor(){_(this,"appElement");_(this,"config",null);_(this,"panoViewer",null);_(this,"titleBar",null);_(this,"topRightControls",null);_(this,"topModeTabs",null);_(this,"sceneTitleEl",null);_(this,"brandMark",null);_(this,"bottomDock",null);_(this,"sceneGuideDrawer",null);_(this,"guideTray",null);_(this,"museumList",null);_(this,"sceneList",null);_(this,"mapOverlay",null);_(this,"hotspots",null);_(this,"videoPlayer",null);_(this,"controlBar",null);_(this,"loading");_(this,"debugPanel",null);_(this,"configStudio",null);_(this,"qualityIndicator",null);_(this,"northCalibrationPanel",null);_(this,"currentMuseum",null);_(this,"currentScene",null);_(this,"hasBoundFullscreenEvents",!1);_(this,"mode","tour");_(this,"modeIndicatorEl",null);_(this,"structureView2D",null);_(this,"structureView3D",null);_(this,"fcChatPanel",null);_(this,"uiErrorElement",null);const e=document.getElementById("app");if(!e)throw new Error("找不到 #app 元素");this.appElement=e,Pc(),this.loading=new Gv,this.appElement.appendChild(this.loading.getElement()),this.bindFullscreenEventsOnce(),this.init()}bindFullscreenEventsOnce(){if(this.hasBoundFullscreenEvents)return;this.hasBoundFullscreenEvents=!0;const e=()=>{var t;(t=this.topRightControls)==null||t.syncFullscreenState(),Qr()||Oc()};document.addEventListener("fullscreenchange",e),document.addEventListener("webkitfullscreenchange",e)}async init(){try{if(this.loading.show(),rd()){await this.initEditorMode(),this.loading.hide();return}this.config=await Na(),this.titleBar&&this.titleBar.setTitle(this.config.appName),window.addEventListener("popstate",()=>this.handleRoute()),await this.handleRoute(),this.loading.hide()}catch(e){console.error("配置加载失败:",e),this.loading.hide(),e.validationErrors&&Array.isArray(e.validationErrors)?this.showConfigErrorPanel(e.validationErrors):this.showError("加载配置失败，请刷新页面重试")}}async initEditorMode(){try{this.config=await Na(),this.appElement.innerHTML="",this.configStudio=new Kv(this.config,e=>{this.config=e,Da()}),this.appElement.appendChild(this.configStudio.getElement())}catch(e){console.error("初始化编辑器模式失败:",e),e.validationErrors&&Array.isArray(e.validationErrors)?this.showConfigErrorPanel(e.validationErrors):this.showError("加载配置失败，请刷新页面重试")}}showConfigErrorPanel(e){this.appElement.innerHTML="";const t=new Wv(e,()=>{Da(),window.location.reload()},()=>{this.showConfigExample()});this.appElement.appendChild(t.getElement())}showConfigExample(){const e=window.open("","_blank");e&&e.document.write(`
        <!DOCTYPE html>
        <html lang="zh-CN">
        <head>
          <meta charset="UTF-8">
  ...
  "museums": [
    {
      ...
      `)}async handleRoute(){if(!this.config)return;const e=Fa();if(this.clearView(),!e.museumId){const t=this.config.museums.find(n=>n.id==="wangding")||this.config.museums[0];if(t){if(t.scenes&&t.scenes.length>0){$t(t.id,t.scenes[0].id);return}Br(t.id);return}}if(!e.museumId)this.showMuseumList();else if(e.sceneId){const t=kr(e.museumId),n=ed(e.museumId,e.sceneId);t&&n?await this.showScene(t,n):(this.showError("未找到指定的场景"),t?Br(t.id):ka())}else{const t=kr(e.museumId);t?this.showSceneList(t):(this.showError("未找到指定的展馆"),ka())}}showMuseumList(){this.config&&(this.titleBar=new Dl(this.config.appName),this.appElement.appendChild(this.titleBar.getElement()),this.museumList=new Mv(this.config.museums),this.appElement.appendChild(this.museumList.getElement()))}showSceneList(e){this.titleBar=new Dl(e.name),this.appElement.appendChild(this.titleBar.getElement());const t=document.createElement("div");t.className="scene-list-page",t.innerHTML=`
    ...
    `,document.head.appendChild(n),t.querySelectorAll(".scene-card").forEach(i=>{i.addEventListener("click",()=>{const r=i.getAttribute("data-scene-id");r&&$t(e.id,r)})}),this.appElement.appendChild(t)}async showScene(e,t){var m,v,g;this.currentMuseum=e,this.currentScene=t,this.loading.show();const n=document.createElement("div");n.className="viewer-container",n.style.cssText=`
      ...
      bottom: 0;
      z-index: 1;
    `,this.appElement.appendChild(n);const i=sd();this.panoViewer=new Sv(n,i);try{this.topRightControls=new i_({viewerRootEl:n,onTogglePickMode:()=>this.panoViewer?(this.panoViewer.isPickModeEnabled()?this.panoViewer.disablePickMode():this.panoViewer.enablePickMode(),this.panoViewer.isPickModeEnabled()):!1,onOpenNorthCalibration:()=>{this.openNorthCalibration(t.id)},showNorthCalibration:!0}),this.appElement.appendChild(this.topRightControls.getElement())}catch(f){ft&&console.debug("[showScene] TopRightControls 创建失败，跳过:",f),this.topRightControls=null}this.sceneTitleEl=document.createElement("div"),this.sceneTitleEl.className="vr-scenetitle",this.sceneTitleEl.textContent=t.name||((m=this.config)==null?void 0:m.appName)||"VR Player",this.appElement.appendChild(this.sceneTitleEl);const r=f=>{const p=f,{x:S,y:x,yaw:T,pitch:L}=p.detail;if(jv({yaw:T,pitch:L,ts:Date.now()}),it(`已复制 yaw: ${T.toFixed(2)}, pitch: ${L.toFixed(2)}`),this.panoViewer){const A=this.panoViewer.getDomElement();U_(A,S,x)}};window.addEventListener("vr:pick",r);const a=f=>{const p=f;this.panoViewer&&!p.detail.enabled&&this.panoViewer.isPickModeEnabled()&&this.panoViewer.disablePickMode()};window.addEventListener("vr:pickmode",a);try{this.brandMark=new a_({appName:(v=this.config)==null?void 0:v.appName,brandText:"鼎虎清源"}),this.appElement.appendChild(this.brandMark.getElement())}catch(f){ft&&console.debug("[showScene] BrandMark 创建失败，跳过:",f),this.brandMark=null}if(i){this.debugPanel=new Yv,this.appElement.appendChild(this.debugPanel.getElement()),this.panoViewer.setOnDebugClick((p,S,x,T,L)=>{this.debugPanel&&this.debugPanel.show(p,S,x,T,L)});const f=()=>{if(this.debugPanel&&this.panoViewer){const p=this.panoViewer.getCurrentView();this.debugPanel.updateView(p.yaw,p.pitch,p.fov)}requestAnimationFrame(f)};f()}try{this.videoPlayer=new zv,this.appElement.appendChild(this.videoPlayer.getElement())}catch(f){ft&&console.debug("[showScene] VideoPlayer 创建失败，跳过:",f),this.videoPlayer=null}try{this.guideTray=new C_({museumId:e.id,currentSceneId:t.id,scenes:e.scenes,onSceneClick:f=>{$t(e.id,f)},onMoreClick:()=>{if(!this.sceneGuideDrawer)try{this.sceneGuideDrawer=new A_({museumId:e.id,currentSceneId:t.id,scenes:e.scenes,onClose:()=>{}}),this.appElement.appendChild(this.sceneGuideDrawer.getElement())}catch(f){ft&&console.debug("[GuideTray] SceneGuideDrawer 创建失败:",f)}this.guideTray&&this.guideTray.setVisible(!1),this.sceneGuideDrawer&&this.sceneGuideDrawer.open()},onClose:()=>{this.guideTray&&this.guideTray.setVisible(!1)}}),this.guideTray.setVisible(!1),this.appElement.appendChild(this.guideTray.getElement())}catch(f){ft&&console.debug("[showScene] GuideTray 创建失败，跳过:",f),this.guideTray=null}const o=new Map;e.scenes.forEach(f=>{let p;if(f.panoLow){const S=yn(f.panoLow,rn.PANO_LOW);S&&(p=S)}else if(f.pano){const S=yn(f.pano,rn.PANO);S&&(p=S)}o.set(f.id,{title:f.name,thumb:f.thumb,panoUrl:p})});try{this.bottomDock=new T_({initialTab:"guide",onGuideClick:()=>{this.guideTray&&this.guideTray.setVisible(!0)},sceneId:t.id,sceneName:t.name,museum:e,scenes:e.scenes,currentSceneId:t.id}),this.appElement.appendChild(this.bottomDock.getElement())}catch(f){ft&&console.debug("[showScene] BottomDock 创建失败，跳过:",f),this.bottomDock=null}try{this.topModeTabs=new I_({initialMode:this.mode,onModeChange:f=>{this.setMode(f)}}),this.appElement.appendChild(this.topModeTabs.getElement())}catch(f){ft&&console.debug("[showScene] TopModeTabs 创建失败，跳过:",f),this.topModeTabs=null}this.modeIndicatorEl=document.createElement("div"),this.modeIndicatorEl.className="vr-mode-indicator",this.modeIndicatorEl.textContent=`mode: ${this.mode}`,this.appElement.appendChild(this.modeIndicatorEl);try{const f=new Map(e.scenes.map(p=>[p.id,p.name]));this.hotspots=new Vv(this.panoViewer,t.hotspots,{resolveSceneName:p=>f.get(p),onEnterScene:p=>{$t(e.id,p)},museumId:e.id}),n.appendChild(this.hotspots.getElement())}catch(f){ft&&console.debug("[showScene] Hotspots 创建失败，跳过:",f),this.hotspots=null}try{this.qualityIndicator=new ov,this.appElement.appendChild(this.qualityIndicator.getElement())}catch(f){ft&&console.debug("[showScene] QualityIndicator 创建失败，跳过:",f),this.qualityIndicator=null}this.panoViewer.setOnStatusChange(f=>{this.qualityIndicator&&this.qualityIndicator.updateStatus(f)}),this.panoViewer.setOnLoad(()=>{this.loading.hide(),this.hideUIError(),this.preloadNextScene(e,t)}),this.panoViewer.setOnError(f=>{console.error("加载场景失败:",f),this.loading.hide(),this.showError("加载全景图失败，请检查网络连接"),this.qualityIndicator&&this.qualityIndicator.updateStatus(Pt.ERROR)});const l=Fa(),c=l.yaw!==void 0?l.yaw:t.initialView.yaw||0,d=l.pitch!==void 0?l.pitch:t.initialView.pitch||0,h=l.fov!==void 0?l.fov:t.initialView.fov||75,u=-c;this.panoViewer.setView(u,d,h),this.panoViewer.loadScene(t),this.panoViewer.setSceneData(e.id,t.id,t.hotspots);try{const f=(g=this.config)==null?void 0:g.fcChat;if(f!=null&&f.endpoint&&f.endpoint.trim()){const p={endpoint:f.endpoint,authToken:f.authToken,timeoutMs:15e3},S=new K_(p);this.fcChatPanel=new Y_(S,{museumId:e.id,sceneId:t.id,sceneTitle:t.name,museumName:e.name,url:window.location.href})}}catch(f){ft&&console.debug("[showScene] FcChatPanel 创建失败，跳过:",f),this.fcChatPanel=null}}preloadNextScene(e,t){const i=(e.scenes.findIndex(a=>a.id===t.id)+1)%e.scenes.length,r=e.scenes[i];r&&r.thumb&&zi(async()=>{const{resolveAssetUrl:a,AssetType:o}=await Promise.resolve().then(()=>av);return{resolveAssetUrl:a,AssetType:o}},void 0,import.meta.url).then(({resolveAssetUrl:a,AssetType:o})=>{const l=a(r.thumb,o.THUMB);if(l){const c=new Image;c.src=l}})}clearView(){this.panoViewer&&(this.panoViewer.dispose(),this.panoViewer=null),this.titleBar&&(this.titleBar.remove(),this.titleBar=null),this.topRightControls&&(this.topRightControls.remove(),this.topRightControls=null),this.northCalibrationPanel&&(this.northCalibrationPanel.close(),this.northCalibrationPanel=null),this.topModeTabs&&(this.topModeTabs.getElement().remove(),this.topModeTabs=null),this.sceneTitleEl&&(this.sceneTitleEl.remove(),this.sceneTitleEl=null),this.brandMark&&(this.brandMark.remove(),this.brandMark=null),this.bottomDock&&(this.bottomDock.remove(),this.bottomDock=null),this.guideTray&&(this.guideTray.remove(),this.guideTray=null),this.sceneGuideDrawer&&(this.sceneGuideDrawer.remove(),this.sceneGuideDrawer=null),this.museumList&&(this.museumList.remove(),this.museumList=null),this.sceneList&&(this.sceneList.remove(),this.sceneList=null),this.mapOverlay&&(this.mapOverlay.remove(),this.mapOverlay=null),this.hotspots&&(this.hotspots.remove(),this.hotspots=null),this.videoPlayer&&(this.videoPlayer.remove(),this.videoPlayer=null),this.controlBar&&(this.controlBar.remove(),this.controlBar=null),this.debugPanel&&(this.debugPanel.remove(),this.debugPanel=null),this.configStudio&&(this.configStudio.remove(),this.configStudio=null),this.qualityIndicator&&(this.qualityIndicator.remove(),this.qualityIndicator=null),this.modeIndicatorEl&&(this.modeIndicatorEl.remove(),this.modeIndicatorEl=null),this.structureView2D&&(this.structureView2D.remove(),this.structureView2D=null),this.structureView3D&&(this.structureView3D.remove(),this.structureView3D=null),this.fcChatPanel&&(this.fcChatPanel.remove(),this.fcChatPanel=null),this.mode="tour",this.appElement.innerHTML="",this.appElement.appendChild(this.loading.getElement())}hideUIError(){this.uiErrorElement&&this.uiErrorElement.parentNode&&(this.uiErrorElement.parentNode.removeChild(this.uiErrorElement),this.uiErrorElement=null)}setMode(e){if(this.mode!==e)if(this.mode=e,this.topModeTabs&&this.topModeTabs.setMode(e),this.modeIndicatorEl&&(this.modeIndicatorEl.textContent=`mode: ${e}`),e==="structure2d"||e==="structure3d"?document.body.style.overflow="hidden":document.body.style.overflow="",e==="structure2d"){if(!this.currentMuseum||!this.currentScene)return;this.structureView3D&&this.structureView3D.close();const t=Gl(this.currentMuseum,this.currentScene.id);this.structureView2D?this.structureView2D.updateContext({museum:this.currentMuseum,graph:t,currentSceneId:this.currentScene.id}):(this.structureView2D=new P_({museum:this.currentMuseum,graph:t,currentSceneId:this.currentScene.id,onNodeClick:(n,i)=>{this.setMode("tour"),$t(n,i)}}),this.appElement.appendChild(this.structureView2D.getElement())),this.structureView2D.open()}else if(e==="structure3d"){if(!this.currentMuseum||!this.currentScene)return;this.structureView2D&&this.structureView2D.close();const t=Gl(this.currentMuseum,this.currentScene.id);this.structureView3D?this.structureView3D.updateContext({museum:this.currentMuseum,graph:t,currentSceneId:this.currentScene.id}):(this.structureView3D=new D_({museum:this.currentMuseum,graph:t,currentSceneId:this.currentScene.id,onNodeClick:(n,i)=>{this.setMode("tour"),$t(n,i)}}),this.appElement.appendChild(this.structureView3D.getElement())),this.structureView3D.open()}else this.structureView2D&&this.structureView2D.close(),this.structureView3D&&this.structureView3D.close()}openNorthCalibration(e){if(this.northCalibrationPanel&&(this.northCalibrationPanel.close(),this.northCalibrationPanel=null),!this.panoViewer){console.warn("[openNorthCalibration] PanoViewer 未初始化");return}try{this.northCalibrationPanel=new W_({getCurrentYaw:()=>{var n;const t=(n=this.panoViewer)==null?void 0:n.getCurrentView();return(t==null?void 0:t.yaw)??0},sceneId:e,onClose:()=>{this.northCalibrationPanel=null}})}catch(t){console.error("[openNorthCalibration] 创建校准面板失败:",t),this.northCalibrationPanel=null}}showError(e){this.hideUIError(),this.uiErrorElement=document.createElement("div"),this.uiErrorElement.className="error-message",this.uiErrorElement.textContent=e,this.uiErrorElement.style.cssText=`
      position: fixed;
      top: 50%;
      left: 50%;
      transform: translate(-50%, -50%);
      ...
      text-align: center;
      max-width: 80vw;
    `,this.appElement.appendChild(this.uiErrorElement),setTimeout(()=>{this.hideUIError()},3e3)}}new Z_;export{l0 as $,da as A,Gt as B,ze as C,Cc as D,Mi as E,h0 as F,fa as G,tn as H,a0 as I,Ei as J,je as K,ji as L,Q_ as M,er as N,ct as O,Bn as P,wi as Q,qi as R,g0 as S,e0 as T,Ut as U,R as V,r0 as W,ut as X,Pg as Y,ha as Z,o0 as _,De as a,mi as a0,wt as a1,vc as a2,wc as a3,d0 as a4,Cg as a5,Rs as a6,Ps as a7,Mc as a8,Tt as a9,Bs as aa,ks as ab,$i as ac,Ke as ad,Rn as ae,qs as af,sn as ag,bn as ah,Pn as b,t0 as c,i0 as d,n0 as e,f0 as f,c0 as g,xn as h,ht as i,u0 as j,p0 as k,Ge as l,ml as m,Xg as n,m0 as o,s0 as p,Xn as q,Hd as r,Xa as s,Nt as t,yt as u,Wr as v,Yr as w,Kt as x,Ng as y,jn as z};
