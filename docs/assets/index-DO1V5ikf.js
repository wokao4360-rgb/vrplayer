...
<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M15 15l3 3" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    `,this.header=document.createElement("div"),this.header.innerText="三馆学伴",this.header.style.cssText=`
      height: 40px;
      line-height: 40px;
      padding: 0 12px;
      font-size: 14px;
      ...
      flex-shrink: 0;
    `,this.root.appendChild(this.header),this.body=document.createElement("div"),this.body.style.cssText=`
      flex: 1;
      padding: 10px;
      overflow-y: auto;
      background: #fafafa;
    `,this.root.appendChild(this.body);const e=document.createElement("div");e.style.cssText=`
      display: flex;
      gap: 8px;
      padding: 8px;
      ...
      background: #fff;
      flex-shrink: 0;
    `,this.input=document.createElement("input"),this.input.placeholder="输入问题，回车发送",this.input.style.cssText=`
      flex: 1;
      height: 32px;
      font-size: 13px;
      padding: 0 10px;
      ...
      outline: none;
    `,this.sendBtn=document.createElement("button"),this.sendBtn.innerText="发送",this.sendBtn.style.cssText=`
      height: 32px;
      padding: 0 14px;
      font-size: 13px;
      border-radius: 8px;
      ...
      background: #2563eb;
      color: #fff;
    `,e.appendChild(this.input),e.appendChild(this.sendBtn),this.root.appendChild(e),document.body.appendChild(this.root),this.sendBtn.onclick=()=>this.send(),this.input.onkeydown=t=>{t.key==="Enter"&&this.send()},this.addMessage("assistant","我是三馆学伴，可以为你介绍展览亮点、参观路线和人物故事。")}bindDrag(){this.header.addEventListener("mousedown",e=>{this.dragging=!0;const t=this.root.getBoundingClientRect();this.dragOffsetX=e.clientX-t.left,this.dragOffsetY=e.clientY-t.top,document.body.style.userSelect="none"}),document.addEventListener("mousemove",e=>{this.dragging&&(this.root.style.left=`${e.clientX-this.dragOffsetX}px`,this.root.style.top=`${e.clientY-this.dragOffsetY}px`,this.root.style.right="auto",this.root.style.bottom="auto")}),document.addEventListener("mouseup",()=>{this.dragging=!1,document.body.style.userSelect=""})}addMessage(e,t){const n=document.createElement("div");n.style.cssText=`
      max-width: 80%;
      margin-bottom: 8px;
      padding: 6px 10px;
      border-radius: 10px;
