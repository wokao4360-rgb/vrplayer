...
`].filter(Mi).join(`
`)),a=wa(a),a=Ul(a,t),a=Ol(a,t),o=wa(o),o=Ul(o,t),o=Ol(o,t),a=Fl(a),o=Fl(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(y=`#version 300 es
...
void main() {
    ...
    `,this.element.querySelectorAll(".museum-card-active").forEach(n=>{n.addEventListener("click",()=>{const i=n.getAttribute("data-museum-id");i&&ma(i)})})}applyStyles(){const e=document.createElement("style");e.textContent=`
      .museum-list {
        width: 100%;
        height: 100%;
        overflow-y: auto;
...
</svg>`}function T_(s){const e=document.createElement("div");return e.className="hotspot-tooltip",e.textContent=s||"",e.setAttribute("role","tooltip"),e}function Ys(s,e){const t=document.createElement("div");return t.className=`hotspot-icon-circle${e?` ${e}`:""}`,t.innerHTML=s,t}function A_(){return`
<svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M12 4v16M12 4l6 6M12 4l-6 6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    `,document.head.appendChild(e)}getElement(){return this.element}remove(){this.element.remove()}}class V_{constructor(){_(this,"element");this.element=document.createElement("div"),this.element.className="loading-overlay",this.render(),this.applyStyles();const e=()=>{rs()&&this.hide()};document.addEventListener("fullscreenchange",e),document.addEventListener("webkitfullscreenchange",e)}render(){this.element.innerHTML=`
    ...
    `,document.head.appendChild(e)}}let In=null;function _d(){return In!==null?In:typeof navigator<"u"&&navigator.maxTouchPoints>0||typeof window<"u"&&("ontouchstart"in window||window.DocumentTouch&&document instanceof window.DocumentTouch)?(In="touch",In):(In="mouse",In)}function yd(){return _d()==="touch"}function xd(){return _d()==="mouse"}function $_(){const s=document;return document.fullscreenElement||s.webkitFullscreenElement||null}function hr(){return!!$_()}async function j_(s){const e=s;if(e.requestFullscreen){await e.requestFullscreen();return}if(e.webkitRequestFullscreen){await e.webkitRequestFullscreen();return}throw new Error("Fullscreen API not supported")}async function K_(){const s=document;if(document.exitFullscreen){await document.exitFullscreen();return}if(s.webkitExitFullscreen){await s.webkitExitFullscreen();return}}async function bd(s){const e=s||document.body;!hr()&&xd()&&Ze("鼠标滑至最上方可退出全屏",700),await j_(e)}async function Na(){try{await K_(),Ed()}catch(s){console.debug("[fullscreen] exitFullscreenBestEffort failed:",s)}}function Ed(){var s,e;try{(e=(s=screen.orientation)==null?void 0:s.unlock)==null||e.call(s)}catch{}}function Z_(){return`
...
<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M15 15l3 3" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    `,document.head.appendChild(e)}getElement(){return this.root}remove(){this.destroy()}}function H0(s){try{return JSON.parse(s)}catch{return null}}function ua(s){return typeof s=="string"?s:""}function z0(s){return s.endsWith("/")?s:s+"/"}function G0(s,e){const t={question:s};return e&&typeof e=="object"&&(t.context={museumId:e.museumId||"",museumName:e.museumName||"",sceneId:e.sceneId||"",sceneTitle:e.sceneTitle||"",url:e.url||""}),t}function W0(s){if(s&&typeof s=="object"&&typeof s.answer=="string"&&s.answer.trim())return{ok:!0,answer:s.answer.trim(),model:ua(s.model)||void 0};if(s&&typeof s=="object"&&("code"in s||"msg"in s||"data"in s)){const e=typeof s.code=="number"?s.code:void 0,t=ua(s.msg)||"",n=s.data;if((e===0||e===void 0)&&n&&typeof n=="object"){const i=typeof n.answer=="string"?n.answer.trim():"";if(i)return{ok:!0,answer:i,model:ua(n.model)||void 0}}if(e===40101||t.toLowerCase()==="unauthorized")return{ok:!1,code:40101,msg:"unauthorized"};if(e!==void 0&&e!==0)return{ok:!1,code:e,msg:t||`error code=${e}`};if(t&&t.toLowerCase()!=="ok")return{ok:!1,code:e,msg:t}}return{ok:!1,msg:"bad response"}}class Y0{constructor(e){_(this,"endpoint");_(this,"authToken");_(this,"timeoutMs");if(!(e!=null&&e.endpoint))throw new Error("fcChat endpoint is empty");this.endpoint=z0(e.endpoint),this.authToken=e.authToken||"",this.timeoutMs=typeof e.timeoutMs=="number"&&e.timeoutMs>0?e.timeoutMs:15e3}async ask(e,t){const n=(e||"").trim();if(!n)throw new Error("empty question");const i=new AbortController,r=setTimeout(()=>i.abort(),this.timeoutMs);try{const a={"Content-Type":"application/json"};this.authToken&&(a.Authorization=this.authToken.startsWith("Bearer ")?this.authToken:`Bearer ${this.authToken}`);const o=await fetch(this.endpoint,{method:"POST",headers:a,body:JSON.stringify(G0(n,t)),signal:i.signal}),l=await o.text(),c=H0(l);if(!c){const u=l?`bad response: ${l}`:`http ${o.status}`;throw new Error(u)}const d=W0(c);if(d.ok)return{answer:d.answer,model:d.model};if(d.code===40101){const u=new Error("unauthorized (code=40101)");throw u.code=40101,u}const h=d.code?`${d.msg} (code=${d.code})`:d.msg;throw new Error(h||"request failed")}catch(a){throw(a==null?void 0:a.name)==="AbortError"?new Error(`timeout (${this.timeoutMs}ms)`):a}finally{clearTimeout(r)}}}let Zn=!1,ts=null,js=null,Ks=null,Zs=!1,Ei=0,Wn=0,Js=!0;const X0=new L(0,0,1),Sc=new ls,q0=new En,$0=new En(-Math.sqrt(.5),0,0,Math.sqrt(.5)),Xs=new En,j0=new L(0,0,-1),K0=new L(0,1,0);let pr=null;function Z0(){const s=screen.orientation,e=s&&typeof s.angle=="number"?s.angle:typeof window.orientation=="number"?window.orientation:0;return Tt.degToRad(e||0)}function J0(s,e,t){const n=Tt.degToRad(s||0),i=Tt.degToRad(e||0),r=Tt.degToRad(t||0),a=Z0();return Sc.set(i,n,-r,"YXZ"),Xs.setFromEuler(Sc),Xs.multiply($0),Xs.multiply(q0.setFromAxisAngle(X0,-a)),Xs.clone()}function pa(s){for(;s>Math.PI;)s-=2*Math.PI;for(;s<-Math.PI;)s+=2*Math.PI;return s}function Q0(s,e,t){s=pa(s),e=pa(e);let n=e-s;return n>Math.PI&&(n-=2*Math.PI),n<-Math.PI&&(n+=2*Math.PI),pa(s+n*t)}function ey(){return/iPhone|iPad|iPod/i.test(navigator.userAgent)}async function ty(){if(!ey())return!0;if(typeof DeviceOrientationEvent.requestPermission=="function")try{return await DeviceOrientationEvent.requestPermission()==="granted"}catch(s){return console.warn("[VRMode] iOS permission request failed:",s),!1}return!0}function ny(s){pr=s}async function iy(s){var t;if(Zn)return!0;if(!await ty())return Ze("未获得陀螺仪权限，无法进入VR模式"),!1;Zs=!1,Ks=null,Ei=0,Wn=0,Js=!0,js=s;try{(t=screen.orientation)!=null&&t.lock&&await screen.orientation.lock("landscape")}catch{}return ts=n=>{if(!Zn||!js||n.alpha===null||n.beta===null||n.gamma===null)return;const i=J0(n.alpha,n.beta,n.gamma);if(!Zs){Ks=i.clone(),Zs=!0;return}if(pr&&pr())return;const r=Ks.clone().invert(),a=i.clone().multiply(r),o=j0.clone().applyQuaternion(a),l=K0.clone().applyQuaternion(a);let c=Math.atan2(o.x,-o.z);c=-c;let d=Math.atan2(l.z,l.y);d=-d;const h=Tt.degToRad(85);d=Math.max(-h,Math.min(h,d)),Js?(Ei=c,Wn=d,Js=!1):(Ei=Q0(Ei,c,.15),Wn=Wn+(d-Wn)*.2);const u=Tt.radToDeg(Ei),f=Tt.radToDeg(Wn);js(u,f)},window.addEventListener("deviceorientation",ts),Zn=!0,!0}function Rd(){var s;if(Zn){ts&&(window.removeEventListener("deviceorientation",ts),ts=null),js=null,Zn=!1,Zs=!1,Ks=null,Ei=0,Wn=0,Js=!0,pr=null;try{(s=screen.orientation)!=null&&s.unlock&&screen.orientation.unlock()}catch{}}}function qs(){return Zn}function sy(){const s=()=>{!rs()&&Zn&&Rd()};document.addEventListener("fullscreenchange",s),document.addEventListener("webkitfullscreenchange",s)}at&&(window.__vrDump=()=>{const s=F0();return console.debug("[VR State Snapshot]",s),s},window.__vrResetUI=()=>{console.debug("[VR Reset UI] 正在清理所有 UI 状态..."),k0(it),console.debug("[VR Reset UI] 清理完成")},console.debug("[VR Debug] 调试模式已启用。使用 __vrDump() 查看状态，使用 __vrResetUI() 复位 UI"));Wd();U0();O0();Kv();sy();const Pd=()=>{const s=document;!!(document.fullscreenElement||s.webkitFullscreenElement)&&N_()};document.addEventListener("fullscreenchange",Pd);document.addEventListener("webkitfullscreenchange",Pd);function ry(){const s=new URLSearchParams(location.search);return s.has("development")||s.get("dev")==="1"||location.hash.includes("development")}class ay{constructor(){_(this,"appElement");_(this,"config",null);_(this,"panoViewer",null);_(this,"titleBar",null);_(this,"topRightControls",null);_(this,"topModeTabs",null);_(this,"sceneTitleEl",null);_(this,"brandMark",null);_(this,"bottomDock",null);_(this,"sceneGuideDrawer",null);_(this,"guideTray",null);_(this,"museumList",null);_(this,"sceneList",null);_(this,"mapOverlay",null);_(this,"hotspots",null);_(this,"videoPlayer",null);_(this,"controlBar",null);_(this,"loading");_(this,"debugPanel",null);_(this,"configStudio",null);_(this,"qualityIndicator",null);_(this,"northCalibrationPanel",null);_(this,"currentMuseum",null);_(this,"currentScene",null);_(this,"hasBoundFullscreenEvents",!1);_(this,"mode","tour");_(this,"isStructureOverlayOpen",!1);_(this,"structureView2D",null);_(this,"structureView3D",null);_(this,"fcChatPanel",null);_(this,"uiErrorElement",null);const e=document.getElementById("app");if(!e)throw new Error("找不到 #app 元素");this.appElement=e,fd(),this.loading=new V_,this.appElement.appendChild(this.loading.getElement()),this.bindFullscreenEventsOnce(),this.init()}bindFullscreenEventsOnce(){if(this.hasBoundFullscreenEvents)return;this.hasBoundFullscreenEvents=!0;const e=()=>{var t;(t=this.topRightControls)==null||t.syncFullscreenState(),hr()||(this.topRightControls&&!qs()&&this.topRightControls.updateVrModeState(!1),this.panoViewer&&this.panoViewer.isVrModeEnabled()&&this.panoViewer.setVrModeEnabled(!1),Ed())};document.addEventListener("fullscreenchange",e),document.addEventListener("webkitfullscreenchange",e)}async init(){try{if(this.loading.show(),qd()){await this.initEditorMode(),this.loading.hide();return}this.config=await po(),this.titleBar&&this.titleBar.setTitle(this.config.appName),window.addEventListener("popstate",()=>this.handleRoute()),await this.handleRoute(),this.loading.hide()}catch(e){console.error("配置加载失败:",e),this.loading.hide(),e.validationErrors&&Array.isArray(e.validationErrors)?this.showConfigErrorPanel(e.validationErrors):this.showError("加载配置失败，请刷新页面重试")}}async initEditorMode(){try{this.config=await po(),this.appElement.innerHTML="",this.configStudio=new q_(this.config,e=>{this.config=e,fo()}),this.appElement.appendChild(this.configStudio.getElement())}catch(e){console.error("初始化编辑器模式失败:",e),e.validationErrors&&Array.isArray(e.validationErrors)?this.showConfigErrorPanel(e.validationErrors):this.showError("加载配置失败，请刷新页面重试")}}showConfigErrorPanel(e){this.appElement.innerHTML="";const t=new H_(e,()=>{fo(),window.location.reload()},()=>{this.showConfigExample()});this.appElement.appendChild(t.getElement())}showConfigExample(){const e=window.open("","_blank");e&&e.document.write(`
        <!DOCTYPE html>
        <html lang="zh-CN">
        <head>
          <meta charset="UTF-8">
  ...
  "museums": [
    {
      ...
      `)}async handleRoute(){if(!this.config)return;const e=vo();if(this.clearView(),!e.museumId){const t=this.config.museums.find(n=>n.id==="wangding")||this.config.museums[0];if(t){if(t.scenes&&t.scenes.length>0){Kt(t.id,t.scenes[0].id);return}ma(t.id);return}}if(!e.museumId)this.showMuseumList();else if(e.sceneId){const t=fa(e.museumId),n=zd(e.museumId,e.sceneId);t&&n?await this.showScene(t,n):(this.showError("未找到指定的场景"),t?ma(t.id):_o())}else{const t=fa(e.museumId);t?this.showSceneList(t):(this.showError("未找到指定的展馆"),_o())}}showMuseumList(){this.config&&(this.titleBar=new fc(this.config.appName),this.appElement.appendChild(this.titleBar.getElement()),this.museumList=new x_(this.config.museums),this.appElement.appendChild(this.museumList.getElement()))}showSceneList(e){this.titleBar=new fc(e.name),this.appElement.appendChild(this.titleBar.getElement());const t=document.createElement("div");t.className="scene-list-page",t.innerHTML=`
