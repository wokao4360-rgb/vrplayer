var N=Object.defineProperty;var z=(l,t,e)=>t in l?N(l,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[t]=e;var a=(l,t,e)=>z(l,typeof t!="symbol"?t+"":t,e);import{l as S,a as _,g as T,t as A,b as P,c as L,d as O}from"./store-B83L8bDT.js";import{s as x}from"./index-Bm5rqhGR.js";const y=40,w=120,R="fcchat_history_v2",I="fcchat_session_v1",U="fcchat_user_memory_v1";function E(l,t){const e=(t||"global").trim()||"global";return`${l}:${e}`}function B(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():`fcchat_${Date.now()}_${Math.random().toString(36).slice(2,10)}`}class D{constructor(t,e){a(this,"client");a(this,"context");a(this,"root");a(this,"header");a(this,"body");a(this,"list");a(this,"input");a(this,"sendBtn");a(this,"clearBtn");a(this,"recallBtn");a(this,"closeBtn");a(this,"statusLine");a(this,"quickActions");a(this,"recallPanel");a(this,"dragging",!1);a(this,"dragOffsetX",0);a(this,"dragOffsetY",0);a(this,"isMobile",!1);a(this,"swipeStartY",0);a(this,"swipeActive",!1);a(this,"messages",[]);a(this,"isOpen",!1);a(this,"fabButton",null);a(this,"historyStorageKey");a(this,"sessionStorageKey");a(this,"userMemoryStorageKey");a(this,"sessionId");a(this,"userMemory",[]);a(this,"recallOpen",!1);a(this,"snapTimer",null);a(this,"isDragging",!1);a(this,"startX",0);a(this,"startY",0);a(this,"startLeft",0);a(this,"startTop",0);a(this,"lastLeft",0);a(this,"lastTop",0);a(this,"moved",!1);a(this,"hasUserPlaced",!1);a(this,"typingTimer",null);a(this,"typingAbortToken",0);this.client=t,this.context=e,this.historyStorageKey=E(R,e.museumId),this.sessionStorageKey=E(I,e.museumId),this.userMemoryStorageKey=E(U,e.museumId),this.sessionId=this.loadSessionId(),this.userMemory=this.loadUserMemory(),this.mount(),this.injectStyles(),this.detectMobile(),this.restoreHistoryOrWelcome()}destroy(){var t,e;this.stopTyping(!0),this.snapTimer&&(window.clearTimeout(this.snapTimer),this.snapTimer=null),(t=this.root)==null||t.remove(),(e=this.fabButton)==null||e.remove(),this.fabButton=null}detectMobile(){var s,n;const t=((s=window.matchMedia)==null?void 0:s.call(window,"(max-width: 768px)").matches)??!1,e=((n=window.matchMedia)==null?void 0:n.call(window,"(pointer: coarse)").matches)??!1;this.isMobile=t||e,this.root.dataset.mobile=this.isMobile?"1":"0"}mount(){this.root=document.createElement("div"),this.root.className="fcchat-root",this.root.setAttribute("role","dialog"),this.root.setAttribute("aria-label","三馆学伴"),this.header=document.createElement("div"),this.header.className="fcchat-header";const t=document.createElement("div");t.className="fcchat-title",t.textContent="三馆学伴";const e=document.createElement("div");e.className="fcchat-header-right",this.clearBtn=document.createElement("button"),this.clearBtn.className="fcchat-btn fcchat-btn-ghost",this.clearBtn.type="button",this.clearBtn.textContent="清空",this.clearBtn.addEventListener("click",()=>this.clear()),this.recallBtn=document.createElement("button"),this.recallBtn.className="fcchat-btn fcchat-btn-ghost",this.recallBtn.type="button",this.recallBtn.textContent="回顾",this.recallBtn.setAttribute("aria-label","查看会话回顾"),this.recallBtn.setAttribute("aria-pressed","false"),this.recallBtn.addEventListener("click",()=>this.toggleRecallPanel()),this.closeBtn=document.createElement("button"),this.closeBtn.className="fcchat-btn fcchat-btn-ghost fcchat-close",this.closeBtn.type="button",this.closeBtn.setAttribute("aria-label","关闭"),this.closeBtn.textContent="×",this.closeBtn.addEventListener("click",()=>this.toggle()),e.appendChild(this.clearBtn),e.appendChild(this.recallBtn),e.appendChild(this.closeBtn);const s=document.createElement("div");s.className="fcchat-header-row",s.appendChild(t),s.appendChild(e),this.header.appendChild(s);const n=document.createElement("div");n.className="fcchat-disclaimer",n.textContent="提示：AI 可能会出错，内容仅供参考；请以现场展陈/讲解为准。",this.header.appendChild(n),this.quickActions=document.createElement("div"),this.quickActions.className="fcchat-quick-actions",[{label:"回顾上文",prompt:"请先简要回顾我们刚才的对话重点，再继续回答。"},{label:"我刚才说了什么？",prompt:"我刚才说了什么？"},{label:"你刚才说了什么？",prompt:"你刚才说了什么？"}].forEach(o=>{const d=document.createElement("button");d.type="button",d.className="fcchat-chip",d.textContent=o.label,d.addEventListener("click",()=>{this.input.value=o.prompt,this.isOpen||this.show(),this.isMobile||this.input.focus()}),this.quickActions.appendChild(d)}),this.header.appendChild(this.quickActions),this.body=document.createElement("div"),this.body.className="fcchat-body",this.recallPanel=document.createElement("div"),this.recallPanel.className="fcchat-recall-panel",this.recallPanel.hidden=!0,this.body.appendChild(this.recallPanel),this.list=document.createElement("div"),this.list.className="fcchat-list",this.body.appendChild(this.list),this.statusLine=document.createElement("div"),this.statusLine.className="fcchat-status",this.statusLine.textContent="",this.body.appendChild(this.statusLine);const c=document.createElement("div");c.className="fcchat-inputbar",this.input=document.createElement("input"),this.input.className="fcchat-input",this.input.type="text",this.input.placeholder="输入问题，回车发送",this.input.addEventListener("keydown",o=>{o.key==="Enter"&&this.onSend()}),this.sendBtn=document.createElement("button"),this.sendBtn.className="fcchat-btn fcchat-btn-primary",this.sendBtn.type="button",this.sendBtn.textContent="发送",this.sendBtn.addEventListener("click",()=>this.onSend()),c.appendChild(this.input),c.appendChild(this.sendBtn),this.root.appendChild(this.header),this.root.appendChild(this.body),this.root.appendChild(c),document.body.appendChild(this.root),this.root.style.display="none",this.root.style.right="18px",this.root.style.bottom="18px",this.ensureToggleButton(),this.header.addEventListener("mousedown",o=>this.onDragStart(o)),window.addEventListener("mousemove",o=>this.onDragMove(o)),window.addEventListener("mouseup",()=>this.onDragEnd()),this.header.addEventListener("pointerdown",o=>this.onSwipeStart(o),{passive:!1}),this.header.addEventListener("pointermove",o=>this.onSwipeMove(o),{passive:!1}),this.header.addEventListener("pointerup",o=>this.onSwipeEnd(o)),this.header.addEventListener("pointercancel",o=>this.onSwipeEnd(o)),window.addEventListener("resize",()=>this.detectMobile())}hide(){this.isOpen&&(this.isOpen=!1,this.stopTyping(!0),this.toggleRecallPanel(!1),this.root.style.display="none",this.root.classList.remove("fcchat-open"),this.fabButton&&this.fabButton.classList.add("fcchat-docked"),document.body.classList.remove("fcchat-open"),this.updateOverlayState())}show(){this.isOpen||(this.isOpen=!0,this.detectMobile(),this.root.style.display="flex",this.root.classList.add("fcchat-open"),this.fabButton&&this.fabButton.classList.remove("fcchat-docked"),document.body.classList.add("fcchat-open"),this.scrollToBottom(),this.isMobile||this.input.focus(),this.updateOverlayState())}toggle(){this.isOpen?this.hide():this.show()}updateOverlayState(){!!(document.querySelector(".vr-modal-overlay")||document.querySelector(".vr-guide-drawer.open")||this.root&&this.root.style.display==="flex")?document.documentElement.classList.add("vr-overlay-open"):document.documentElement.classList.remove("vr-overlay-open")}getSafeBounds(){const t=window.innerWidth,e=window.innerHeight,s=this.fabButton;if(!s)return{minLeft:8,maxLeft:t-52,minTop:12,maxTop:e-64};const n=s.getBoundingClientRect(),i=n.width,c=n.height,o=12+(this.isMobile?56:12),d=12+(this.isMobile?96:12);return{minLeft:8,maxLeft:t-i-8,minTop:o,maxTop:e-c-d}}clampPos(t,e){const s=this.getSafeBounds();return{left:Math.max(s.minLeft,Math.min(t,s.maxLeft)),top:Math.max(s.minTop,Math.min(e,s.maxTop))}}snapToEdge(){const t=this.fabButton;if(!t)return;const e=this.getSafeBounds(),s=t.getBoundingClientRect(),n=s.left,i=s.top,c=n-e.minLeft,o=e.maxLeft-n,d=i-e.minTop,u=e.maxTop-i,m=Math.min(c,o,d,u);let f=n,p=i;m===c?f=e.minLeft:m===o?f=e.maxLeft:m===d?p=e.minTop:m===u&&(p=e.maxTop),t.style.left=`${f}px`,t.style.top=`${p}px`,t.style.right="auto",t.style.bottom="auto",localStorage.setItem("fcchat_fab_pos_v1",JSON.stringify({left:f,top:p})),setTimeout(()=>{t.classList.remove("fcchat-snapping")},220)}ensureToggleButton(){if(this.fabButton)return;const t=new URLSearchParams(location.search);if(t.get("reset_ui")==="1"){localStorage.removeItem("vr_fcchat_dock_state"),t.delete("reset_ui");const n=location.pathname+(t.toString()?"?"+t.toString():"")+location.hash;history.replaceState({},"",n)}const e=document.createElement("button");e.id="fcchat-fab",e.className="fcchat-fab fcchat-docked",e.type="button",e.setAttribute("aria-label","打开三馆学伴"),e.innerHTML=`<svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    `,document.head.appendChild(t)}getElement(){return this.root}remove(){this.destroy()}}const V=Object.freeze(Object.defineProperty({__proto__:null,FcChatPanel:D},Symbol.toStringTag,{value:"Module"})),v=1600,$=800,H=3200;function Y(l){try{return JSON.parse(l)}catch{return null}}function C(l){return typeof l=="string"?l:""}function F(l){return l.endsWith("/")?l:l+"/"}function k(l){return(l||"").replace(/\s+/g,"").trim()}function K(l,t,e=[],s=""){const n=e.map(r=>({role:r.role==="assistant"?"assistant":"user",content:typeof r.text=="string"?r.text.trim():"",text:typeof r.text=="string"?r.text.trim():""})).filter(r=>!!r.content),i=k(l),c=Array.isArray(t==null?void 0:t.userMemory)?t.userMemory.map(r=>typeof r=="string"?r.trim():"").filter(r=>!!r).filter(r=>k(r)!==i).slice(-30):[],o=(r,h)=>{const b=r.trim();return b.length<=h?b:`${b.slice(0,h)}...`};let d="",u=!1;for(let r=n.length-1;r>=0;r--){const h=n[r];if(h.role!=="user"||!h.text)continue;const b=k(h.text);if(!u&&b===i){u=!0;continue}d=h.text;break}let m="";for(let r=n.length-1;r>=0;r--){const h=n[r];if(h.role==="assistant"&&h.text){m=h.text;break}}const f=n.slice(-8).map(r=>({role:r.role,text:o(r.text,v),content:o(r.text,v)})),p=n.slice(-20).map(r=>({role:r.role,text:o(r.text,v),content:o(r.text,v)})),g={question:l,rawQuestion:l};if(s&&(g.sessionId=s,g.conversationId=s),n.length>0&&(g.history=n,g.messages=n,g.chatHistory=n.map(r=>({role:r.role,text:r.text}))),t&&typeof t=="object"){const r=Array.isArray(t.recentTurns)?t.recentTurns:[];g.context={museumId:t.museumId||"",museumName:t.museumName||"",sceneId:t.sceneId||"",sceneTitle:t.sceneTitle||"",url:t.url||"",sessionId:s||"",historyLength:n.length,userMemory:c,userMemoryLength:c.length,lastUserUtterance:t!=null&&t.lastUserUtterance||d?o((t==null?void 0:t.lastUserUtterance)||d,$):"",lastAssistantReply:t!=null&&t.lastAssistantReply||m?o((t==null?void 0:t.lastAssistantReply)||m,H):"",recentTurns:r.length>0?r.slice(-8).map(h=>({role:h.role==="assistant"?"assistant":"user",text:o(typeof h.text=="string"?h.text:"",v),content:o(typeof h.text=="string"?h.text:"",v)})):f,history:p,messages:p,chatHistory:p.map(h=>({role:h.role,text:h.text}))}}return g}function X(l){if(l&&typeof l=="object"&&typeof l.answer=="string"&&l.answer.trim())return{ok:!0,answer:l.answer.trim(),model:C(l.model)||void 0};if(l&&typeof l=="object"&&("code"in l||"msg"in l||"data"in l)){const t=typeof l.code=="number"?l.code:void 0,e=C(l.msg)||"",s=l.data;if((t===0||t===void 0)&&s&&typeof s=="object"){const n=typeof s.answer=="string"?s.answer.trim():"";if(n)return{ok:!0,answer:n,model:C(s.model)||void 0}}if(t===40101||e.toLowerCase()==="unauthorized")return{ok:!1,code:40101,msg:"unauthorized"};if(t!==void 0&&t!==0)return{ok:!1,code:t,msg:e||`error code=${t}`};if(e&&e.toLowerCase()!=="ok")return{ok:!1,code:t,msg:e}}return{ok:!1,msg:"bad response"}}class q{constructor(t){a(this,"endpoint");a(this,"authToken");a(this,"timeoutMs");if(!(t!=null&&t.endpoint))throw new Error("fcChat endpoint is empty");this.endpoint=F(t.endpoint),this.authToken=t.authToken||"",this.timeoutMs=typeof t.timeoutMs=="number"&&t.timeoutMs>0?t.timeoutMs:15e3}async ask(t,e,s=[],n=""){const i=(t||"").trim();if(!i)throw new Error("empty question");const c=new AbortController,o=setTimeout(()=>c.abort(),this.timeoutMs);try{const d={"Content-Type":"application/json"};this.authToken&&(d.Authorization=this.authToken.startsWith("Bearer ")?this.authToken:`Bearer ${this.authToken}`);const u=await fetch(this.endpoint,{method:"POST",headers:d,body:JSON.stringify(K(i,e,s,n)),signal:c.signal}),m=await u.text(),f=Y(m);if(!f){const r=m?`bad response: ${m}`:`http ${u.status}`;throw new Error(r)}const p=X(f);if(p.ok)return{answer:p.answer,model:p.model};if(p.code===40101){const r=new Error("unauthorized (code=40101)");throw r.code=40101,r}const g=p.code?`${p.msg} (code=${p.code})`:p.msg;throw new Error(g||"request failed")}catch(d){throw(d==null?void 0:d.name)==="AbortError"?new Error(`timeout (${this.timeoutMs}ms)`):d}finally{clearTimeout(o)}}}const Z=Object.freeze(Object.defineProperty({__proto__:null,FcChatClient:q},Symbol.toStringTag,{value:"Module"}));class W{constructor(t={}){a(this,"element");a(this,"isOpen",!1);a(this,"inputEl");a(this,"options");a(this,"handleKeyDownBound");this.options=t,this.handleKeyDownBound=h=>this.handleKeyDown(h),this.element=document.createElement("div"),this.element.className="vr-modal vr-login-modal";const e=document.createElement("div");e.className="vr-modal-mask";const s=document.createElement("div");s.className="vr-modal-card vr-login-card";const n=document.createElement("div");n.className="vr-login-title-row";const i=document.createElement("div");i.className="vr-modal-title",i.textContent="登录";const c=document.createElement("button");c.className="vr-btn vr-login-close",c.setAttribute("aria-label","关闭"),c.textContent="×",c.addEventListener("click",()=>this.close()),n.appendChild(i),n.appendChild(c);const o=document.createElement("div");o.className="vr-modal-desc",o.textContent="输入用户名即可参与互动";const d=document.createElement("div");d.className="vr-login-form",this.inputEl=document.createElement("input"),this.inputEl.className="vr-login-input",this.inputEl.type="text",this.inputEl.placeholder="用户名（2-12字）",this.inputEl.maxLength=12,this.inputEl.addEventListener("keydown",h=>{h.key==="Enter"&&this.handleConfirm()});const u=document.createElement("div");u.className="vr-modal-actions vr-login-actions";const m=document.createElement("button");m.className="vr-btn vr-login-btn",m.textContent="取消",m.addEventListener("click",()=>this.close());const f=document.createElement("button");f.className="vr-btn vr-login-btn danger",f.textContent="退出登录",f.addEventListener("click",()=>{var h,b;S(),(b=(h=this.options).onLogout)==null||b.call(h),this.close()});const p=document.createElement("button");p.className="vr-btn vr-login-btn primary",p.textContent="确认",p.addEventListener("click",()=>this.handleConfirm()),u.appendChild(m),u.appendChild(f),u.appendChild(p),d.appendChild(this.inputEl),s.appendChild(n),s.appendChild(o),s.appendChild(d),s.appendChild(u),e.addEventListener("click",()=>this.close()),s.addEventListener("click",h=>h.stopPropagation()),this.element.appendChild(e),this.element.appendChild(s);const g=()=>{const h=T();f.style.display=h?"inline-flex":"none"},r=this.open.bind(this);this.open=()=>{g(),r()}}handleKeyDown(t){this.isOpen&&t.key==="Escape"&&this.close()}handleConfirm(){var s,n;const t=(this.inputEl.value||"").trim();if(t.length<2||t.length>12){x("用户名需 2-12 字");return}const e=_(t);(n=(s=this.options).onLogin)==null||n.call(s,e),this.close()}open(){if(this.isOpen)return;this.isOpen=!0,window.addEventListener("keydown",this.handleKeyDownBound);const t=T();this.inputEl.value=(t==null?void 0:t.name)||"",this.element.classList.add("open"),window.setTimeout(()=>this.inputEl.focus(),60)}close(){this.isOpen&&(this.isOpen=!1,window.removeEventListener("keydown",this.handleKeyDownBound),this.element.classList.remove("open"))}getElement(){return this.element}remove(){window.removeEventListener("keydown",this.handleKeyDownBound),this.element.remove()}}class J{constructor(t){a(this,"element");a(this,"sceneId");a(this,"sceneName");a(this,"onClose");a(this,"subtitleEl");a(this,"loginHintBtn");a(this,"userLineEl");a(this,"userNameEl");a(this,"likeBtn");a(this,"likeCountEl");a(this,"commentsEl");a(this,"inputEl");a(this,"sendBtn");a(this,"loginModal");a(this,"highlightNextFirstComment",!1);this.sceneId=t.sceneId,this.sceneName=t.sceneName,this.onClose=t.onClose,this.element=document.createElement("div"),this.element.className="vr-community";const e=document.createElement("div");e.className="vr-community-header";const s=document.createElement("div");s.className="vr-community-title",s.textContent="社区",this.subtitleEl=document.createElement("div"),this.subtitleEl.className="vr-community-subtitle";const n=document.createElement("button");n.className="vr-community-close",n.innerHTML="×",n.setAttribute("aria-label","关闭"),n.style.pointerEvents="auto",n.style.zIndex="10",n.addEventListener("click",m=>{var f;m.preventDefault(),m.stopPropagation(),m.stopImmediatePropagation(),(f=this.onClose)==null||f.call(this),window.dispatchEvent(new CustomEvent("vr:dock-tab-close",{detail:{tab:"community"}}))}),e.appendChild(s),e.appendChild(this.subtitleEl),e.appendChild(n);const i=document.createElement("div");i.className="vr-community-content";const c=document.createElement("div");c.className="vr-community-auth",this.loginHintBtn=document.createElement("button"),this.loginHintBtn.className="vr-btn vr-community-login-hint",this.loginHintBtn.textContent="登录后可参与互动",this.userLineEl=document.createElement("div"),this.userLineEl.className="vr-community-userline",this.userNameEl=document.createElement("div"),this.userNameEl.className="vr-community-username";const o=document.createElement("button");o.className="vr-btn vr-community-logout",o.textContent="退出登录",o.addEventListener("click",()=>{S(),this.refresh(),this.toast("已退出登录")}),this.userLineEl.appendChild(this.userNameEl),this.userLineEl.appendChild(o),c.appendChild(this.loginHintBtn),c.appendChild(this.userLineEl);const d=document.createElement("div");d.className="vr-community-like",this.likeBtn=document.createElement("button"),this.likeBtn.className="vr-btn vr-community-likebtn",this.likeBtn.textContent="点赞",this.likeCountEl=document.createElement("div"),this.likeCountEl.className="vr-community-likecount",this.likeBtn.addEventListener("click",()=>{const m=A(this.sceneId);if(!m.ok){x("请先登录"),this.loginModal.open();return}this.renderLikes(m.count,m.action==="liked"),x(m.action==="liked"?"已点赞":"已取消点赞")}),d.appendChild(this.likeBtn),d.appendChild(this.likeCountEl),this.commentsEl=document.createElement("div"),this.commentsEl.className="vr-community-comments";const u=document.createElement("div");u.className="vr-community-inputrow",this.inputEl=document.createElement("input"),this.inputEl.className="vr-community-input",this.inputEl.type="text",this.inputEl.placeholder="写下你的想法…",this.inputEl.maxLength=120,this.inputEl.addEventListener("keydown",m=>{m.key==="Enter"&&this.handleSend()}),this.sendBtn=document.createElement("button"),this.sendBtn.className="vr-btn vr-community-send",this.sendBtn.textContent="发送",this.sendBtn.addEventListener("click",()=>this.handleSend()),u.appendChild(this.inputEl),u.appendChild(this.sendBtn),i.appendChild(c),i.appendChild(d),i.appendChild(this.commentsEl),i.appendChild(u),this.element.appendChild(e),this.element.appendChild(i),this.loginModal=new W({onLogin:()=>{this.refresh(),this.toast("登录成功")},onLogout:()=>{this.refresh()}}),document.body.appendChild(this.loginModal.getElement()),this.loginHintBtn.addEventListener("click",()=>this.loginModal.open()),this.setScene(t.sceneId,t.sceneName)}setScene(t,e){this.sceneId=t,this.sceneName=e,this.subtitleEl.textContent=this.sceneName?this.sceneName:t,this.refresh()}toastByReason(t){t==="not_logged_in"?x("请先登录"):t==="banned"?x("内容包含敏感词，已拦截"):t==="cooldown"?x("评论过于频繁，请稍后再试"):t==="EMPTY"&&x("内容不能为空")}formatRelativeTime(t){const e=Date.now()-t;if(e<6e4)return"刚刚";const s=Math.floor(e/6e4);if(s<60)return`${s} 分钟前`;const n=Math.floor(s/60);return n<24?`${n} 小时前`:new Date(t).toLocaleDateString("zh-CN",{month:"2-digit",day:"2-digit"})}renderLikes(t,e){this.likeCountEl.textContent=String(t),this.likeBtn.classList.toggle("liked",e)}renderComments(t){this.commentsEl.innerHTML="";const e=document.createElement("div");if(e.className="vr-community-tip",e.textContent="本场景最近 50 条留言",this.commentsEl.appendChild(e),!t.length){const n=document.createElement("div");n.className="vr-community-empty",n.textContent="此场景暂无留言",this.commentsEl.appendChild(n);return}let s=null;for(const n of t){const i=document.createElement("div");i.className="vr-community-comment";const c=document.createElement("div");c.className="vr-community-comment-meta",c.textContent=`${n.userName} · ${this.formatRelativeTime(n.ts)}`;const o=document.createElement("div");o.className="vr-community-comment-text",o.textContent=n.text,i.appendChild(c),i.appendChild(o),this.commentsEl.appendChild(i),s||(s=i)}s&&this.highlightNextFirstComment&&(s.classList.add("vr-community-comment--flash"),this.commentsEl.scrollTop=0,window.setTimeout(()=>{s==null||s.classList.remove("vr-community-comment--flash")},300)),this.highlightNextFirstComment=!1}handleSend(){const e=(this.inputEl.value||"").trim();if(!e){this.toastByReason("EMPTY");return}const s=P(this.sceneId,e);if(!s.ok){s.reason==="not_logged_in"?(this.toastByReason("not_logged_in"),this.loginModal.open()):this.toastByReason(s.reason);return}this.inputEl.value="",this.refresh(),this.highlightNextFirstComment=!0,x("评论已发布")}refresh(){const t=T();this.loginHintBtn.style.display=t?"none":"inline-flex",this.userLineEl.style.display=t?"flex":"none",this.userNameEl.textContent=t?t.name:"";const e=L(this.sceneId,(t==null?void 0:t.id)||"anon").count,s=t?L(this.sceneId,t.id).liked:!1;this.renderLikes(e,s),this.renderComments(O(this.sceneId));const n=!t;this.inputEl.disabled=n,this.sendBtn.classList.toggle("disabled",n)}getElement(){return this.element}remove(){this.loginModal.remove(),this.element.remove()}}const tt=Object.freeze(Object.defineProperty({__proto__:null,CommunityPanel:J},Symbol.toStringTag,{value:"Module"}));export{tt as C,V as F,Z as f};
