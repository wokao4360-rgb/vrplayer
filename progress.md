...
## 2026-02-20 21:37:52
- 继续修复“事实记忆丢失”：`src/ui/FcChatPanel.ts` 新增本地回忆分支，命中“我今天干了什么/我刚才说了什么”等问题时，直接从本地 user 历史回忆并回复。
- 回忆源过滤规则已加入：自动跳过“我叫什么/我今天干了什么/你好/谢谢”等无效候选，优先回忆含“今天/刚才/去了/做了/参观”等事实表达的最近一句。
