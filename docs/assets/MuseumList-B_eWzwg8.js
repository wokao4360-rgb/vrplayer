var l=Object.defineProperty;var u=(i,s,t)=>s in i?l(i,s,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[s]=t;var m=(i,s,t)=>u(i,typeof s!="symbol"?s+"":s,t);import{r as n,A as r,k as d}from"./index-CXvOwlF5.js";class g{constructor(s,t="VR 全景导览"){m(this,"element");this.museums=s,this.appName=t,this.element=document.createElement("div"),this.element.className="museum-list",this.render(),this.applyStyles()}render(){const s=this.museums.filter(e=>e.scenes.length>0),t=this.museums.filter(e=>e.scenes.length===0),o=s.length>1?`当前开放 ${s.length} 个展馆`:s.length===1?"当前开放 1 个展馆":"展馆内容正在整理中";this.element.innerHTML=`
